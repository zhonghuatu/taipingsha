...
game.import('card',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			gw_dieyi_judge:'蝶翼·判',
			gw_dieyi_equip1_info:'在你从工具区中失去此牌后，你获得一枚“蝶翼”标记；在任意角色的结束阶段，你移去所有“蝶翼”标记，并随机弃置等量的牌',
			gw_dieyi_equip2_info:'在你从工具区中失去此牌后，你获得一枚“蝶翼”标记；在任意角色的结束阶段，你移去所有“蝶翼”标记，并随机弃置等量的牌',
			gw_dieyi_equip3_info:'在你从工具区中失去此牌后，你获得一枚“蝶翼”标记；在任意角色的结束阶段，你移去所有“蝶翼”标记，并随机弃置等量的牌',
			gw_dieyi_equip4_info:'在你从工具区中失去此牌后，你获得一枚“蝶翼”标记；在任意角色的结束阶段，你移去所有“蝶翼”标记，并随机弃置等量的牌',
			gw_dieyi_equip5_info:'在你从工具区中失去此牌后，你获得一枚“蝶翼”标记；在任意角色的结束阶段，你移去所有“蝶翼”标记，并随机弃置等量的牌',
