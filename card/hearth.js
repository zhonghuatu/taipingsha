...
game.import('card',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			shihuawuqi:'石化助学',
			shihuawuqi_infox:'本回合内攻击范围+1；若你手牌中没有问，则从牌堆中获得一张问',
			shandianjian:'就寝讲话箭',
			shandianjian_info:'目标角色展示一张手牌，然后若你能弃掉一张与所展示牌相同花色的手牌，则对该角色造成1点理竞扣分。',
			shijieshu:'视界术',
