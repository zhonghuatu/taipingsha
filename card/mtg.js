...
game.import('card',function(lib,game,ui,get,ai,_status){
	return {
		...
		card:{
			mtg_lindixiliu:{
				...
				content:function(){
					...
					}).set('prompt2','弃置任意张语文牌，每弃置一张牌，将一张延时动作牌置入一名随机敌方角色的判定区');
					'step 2'
					if(result.bool){
			...
			mtg_longlushanfeng:{
				...
				content:function(){
					...
					player.chooseControl('获得问','获得答').set('prompt','选择一项').set('ai',function(){
						var player=_status.event.player;
						if(player.hasShan()) return 0;
						return 1;
					});
					'step 1'
					if(result.control=='获得问'){
			...
			mtg_yixialan:{
				...
				content:function(){
					...
					player.chooseControl('基本牌','动作牌').set('prompt','选择一个类型获得该类型的一张牌').set('ai',function(){
						var player=_status.event.player;
			...
			mtg_duzhao:{
				...
				content:function(){
					...
					player.chooseTarget('选择一名角色令其获得一张禁',true).set('ai',function(target){
		...
		translate:{
			...
			mtg_yixialan_info:'选项一：随机获得一张基本牌；选项二：随机获得一张动作牌。地图效果：出牌阶段限一次，你可以将一张基本牌重铸为动作牌',
			mtg_yixialan_skill_info:'出牌阶段限一次，你可以将一张基本牌重铸为动作牌',
			...
			mtg_youlin:'幽林',
			mtg_youlin_skill:'幽林',
			mtg_youlin_info:'随机使用一张普通动作牌，随机指定一个具有正收益的目标。地图效果：出牌阶段限一次，你可以弃置一张动作牌并发现一张牌',
			mtg_youlin_skill_info:'出牌阶段限一次，你可以弃置一张动作牌并发现一张牌',
			...
			mtg_duzhao:'禁沼',
			mtg_duzhao_skill:'禁沼',
			mtg_duzhao_info:'选择一名角色令其获得一张禁。地图效果：结束阶段，你获得一张禁',
			mtg_duzhao_skill_info:'结束阶段，你获得一张禁',
			mtg_linzhongjianta:'林中尖塔',
			mtg_linzhongjianta_skill:'林中尖塔',
			mtg_linzhongjianta_info:'发现一张助学牌并工具之。地图效果：若你工具区内有助学牌，你可以将一张基本牌当作问使用',
			mtg_linzhongjianta_skill_info:'若你工具区内有助学牌，你可以将一张基本牌当作问使用',
			...
			mtg_longlushanfeng_info:'选项一：获得一张问；选项二：获得一张答。地图效果：你出问的次数上限+1',
			mtg_longlushanfeng_skill_info:'你出问的次数上限+1',
			mtg_bingheyaosai:'冰河要塞',
			mtg_bingheyaosai_skill:'冰河要塞',
			mtg_bingheyaosai_info:'摸两张牌，然后弃置两张牌。地图效果：锁定技，每当你使用一张问，若你有牌，则需弃置一张牌',
			mtg_bingheyaosai_skill_info:'锁定技，每当你使用一张问，若你有牌，则需弃置一张牌',
			mtg_lindixiliu:'林地溪流',
			mtg_lindixiliu_skill:'林地溪流',
			mtg_lindixiliu_info:'从牌堆中摸一张语文牌，然后弃置任意张语文牌，每弃置一张牌，将一张延时动作牌置入一名随机敌方角色的判定区；。地图效果：准备阶段，你可以弃置一张语文牌，然后弃置判定区内的一张牌',
			mtg_lindixiliu_skill_info:'准备阶段，你可以弃置一张语文牌，然后弃置判定区内的一张牌',
		},
		help:{
			'万智牌':'<ul><li>地图牌可于出牌阶段使用，每阶段最多使用一张地图牌<li>'+
			'地图牌分为两部分：即时效果以及地图效果，即时效果由使用者在使用时选择；地图效果对所有角色有效<li>'+
			'当使用者退学或下个回合开始时，当前地图效果消失<li>'+
			'新地图被使用时会覆盖当前地图效果'
		},
		list:[
