...
game.import('character',
	...
	return {
		...
		character: {
			...
			wangzile: ['male', 'wu', 2, ['tps_xingyun', 'tps_laolian']],
		...
		translate: {
			...
			tps_luanma: '乱码',
			tps_luanma_info: '准备阶段，你可以进行一定判定，若为英语A，你与你同阵营的人全部死亡（非身份模式下判定立即失败）；若为英语2，你弃10张牌并跳过摸牌和出牌阶段；若为英语3，你弃5张牌；若为英语4，你立即死亡；若为英语5，你立即翻面；若为科学A，与你不同阵营的人全部死亡（非身份模式下判定立即胜利）；若为科学2，你摸10张牌；若为科学3，你摸5张牌；若为科学4，你可选择一个人令其立即死亡；若为科学5，你可选择一个人令其立即翻面。',
			...
			tps_zhitiao:'纸条',
			tps_zhitiao_info:'每当你于回合外使用或打出一张手牌时，你可以亮出牌堆顶的一张牌，若此牌与你此次使用或打出的牌类别相同，你可以将之交给任意一名角色；若不同则你可以将之置入弃牌堆。',
			tps_tongxiao: "通校",
