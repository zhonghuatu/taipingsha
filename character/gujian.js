...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterIntro:{
			...
			gjqt_fengqingxue:'来自幽暗无边的地界，大哥为幽都娲皇神殿“十巫”之一的巫咸——风广陌。奉命寻兄而来到人间，邂逅百里屠苏，陷入了焚寂的宿命纠葛。后与百里屠苏相知相爱。终局，百里屠苏化为永世无法轮回的荒魂，她为寻找重生之法，放弃自己的轮回，换取下长久的寿命，在人间执着不悔地寻觅了九百年。最后，与重生后的屠苏回到补作业花谷相守。',
			...
			gjqt_yinqianshang:'原名风广陌，是幽都“十巫”之一的巫咸。奉女娲之命前往乌蒙灵谷增强焚寂封印。但因为欧阳少恭与校级严的争夺关系，他受到焚寂之力力量冲击，失去记忆，后为欧阳少恭所救。尹千觞为了报恩，跟随在百里屠苏等人身边监视。在这个过程中，他慢慢恢复过往的记忆。后为阻止欧阳少恭，随众人前往蓬莱决战。最后，对曾给予他一次重生的欧阳少恭以死相陪，一起归于年级海。',
			gjqt_hongyu:'上古庆枫族族人，紫胤真人的剑灵，宿体为古剑·红玉。在百里屠苏离开昆仑山天墉城后，奉命随行保护。终局之后，她依然回到了天墉城，陪伴在紫胤真人身边。',

			gjqt_yuewuyi:'成长于长安富商家庭。其养父曾是战功显赫的将军，退隐后从商，很快就富甲一方；其养母是精擅偃术的南疆天玄教偃女族传人，待无异一如己出般疼爱有加；无异的生父是捐毒大将兀年级罗，亡母是一名中原女子，因此他具有一半胡人的血统。',
		...
		skill:{
			...
			chizhen:{
				...
				content:function(){
					...
					if(useCard){
						player.chooseTarget('是否视为使用一张核对作业？',function(card,player,target){
			...
			meiying:{
				...
				content:function(){
					"step 0"
					var next=player.chooseToDiscard('he','魅影：是否弃置一张文科牌视为对'+get.translation(trigger.player)+'使用一张杀？');
		...
		translate:{
			...
			zuiji:'醉饮',
			zuiji_info:'出牌阶段，你可以将一张手牌或工具牌当作辣条使用',
			manwu:'曼舞',
			manwu_info:'在一名角色的结束阶段，若其手牌数为全场最少或之一，你可以令其摸一张牌',
			xfanghua:'芳华',
			xfanghua_info:'在你成为文科牌的目标后，你可以回复一点体力',
			yunyin:'云音',
			yunyin_info:'结束阶段，你可以弃置一张与本回合使用过的卡牌花色均不相同的手牌，视为使用一张基本牌或普通动作牌',
			shishui:'逝水',
			shishui_info:'锁定技，每当你使用一张文科牌，你令目标流失一点体力',
			duhun:'渡魂',
			duhun_info:'将退学阶段，你可以与一名体力值不超过你的体力上限的角色排名，若你赢，你失去一点体力上限并与该角色交换体力值；若你没赢，你立即死亡',
			duhun_info_alter:'将退学阶段，你可以与一名体力值不超过你的体力上限的角色排名，若你赢，你失去一点体力上限并将体力值回复至与该角色相同；若你没赢，你立即死亡',
			chizhen:'驰阵',
			chizhen_info:'出牌阶段开始时，你可以摸X张牌并弃置X张牌，若你弃置了杀，可以视为使用一张核对作业（X为你已损失的体力值且至少为1）',
			xidie:'戏蝶',
			xidie2:'戏蝶',
			...
			meiying:'魅影',
			meiying_info:'一名其他角色的回合结束时，若其未于此回合内使用过指定另一名角色为目标的牌，你可以弃置一张文科牌视为对其使用一张杀',
			zuizhan:'乱斩',
			zuizhan_info:'每当你使用一张杀，可以摸一张牌，然后此杀随机增加一个额外目标',
			xlqianhuan:'千幻',
			xlqianhuan_info:'回合结束后，若你已受伤，你可以回复一点体力并将角色牌旷课。若你的角色牌背面朝上，你不能使用卡牌，也不能成为卡牌的目标',
			fumo:'伏魔',
			fumo_info:'每当你受到一次扣分，可以弃置两张颜色相同的手牌并对扣分来源造成一点校级电扣分',
			fanyin:'梵音',
			fanyin_info:'结束阶段，你可以令其他一名角色复原角色牌。若其体力值是全场最少的之一，其回复一点体力。',
			mingkong:'明空',
			mingkong_info:'锁定技，若你没有手牌，你受到的扣分-1，然后扣分来源摸一张牌',
			qinglan:'晴岚',
			qinglan_info:'每当有一名角色即将受到属性扣分，你可以弃置一张牌令其防止此扣分，然后扣分来源摸一张牌并回复一点体力',
			yuehua:'月华',
			yuehua_info:'每当你于回合外使用、打出或弃置文科牌，你可以摸一张牌',
			xuelu:'血戮',
			xuelu_info:'结束阶段，若你已受伤，你可以弃置一张文科牌并对一名其他角色造成一点年级焰扣分；若你已损失体力值不少于3，改为造成两点年级焰扣分',
			xuelu_info_alter:'结束阶段，若你已受伤，你可以弃置一张文科牌并对一名其他角色造成一点年级焰扣分',
			fanshi:'反噬',
			fanshi_info:'锁定技，弃牌阶段结束时，若你本回合内造成过扣分，你流失一点体力并摸一张牌',
			shahun:'煞魂',
			shahun2:'煞魂',
			shahun_info:'限定技，将退学阶段，你可以复原角色牌，弃置所有牌并摸三张牌，然后将体力回复至1；若如此做，你失去技能【反噬】，获得技能【绝境】，并于三回合后立即死亡',
			shahun_info_alter:'限定技，将退学阶段，你可以复原角色牌，弃置所有牌并摸三张牌，然后将体力回复至1；若如此做，你失去技能【反噬】，获得技能【绝境】，并于两回合后立即死亡',
			...
			liuying:'流影',
			liuying_info:'每当你使用一张杀结算完毕后，你可以指定一名本回合未成为过你的杀的目标的角色，并亮出牌堆顶的一张牌，若为理科，你对该角色使用一张杀',
			boyun:'拨云',
			boyun1:'拨云',
			boyun2:'拨云',
			...
			yangming_info:'出牌阶段，你可以弃置一张文科牌，并在下个出牌阶段结束时令距离1以内的任意名角色回复一点体力，在此之前不可再次发动',
			zhaolu:'朝露',
			jiehuo:'劫年级',
			yuling:'御灵',
			yuling1:'御灵',
			...
			yuling3:'御灵',
			yuling4:'御灵',
			zhaolu_info:'锁定技，每隔X回合，你流失一点体力上限，每当你受到一点扣分或有人死亡，视为减少两个回合，X为现存角色数且至多为5',
			jiehuo_info:'限定技，出牌阶段，你可以对一名其他角色造成两点年级焰扣分，然后死亡',
