...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterIntro:{
			...
			hs_malfurion:'在德鲁伊的守护神、半神塞纳留斯的指引下，玛法里奥·怒风千年以来一直保护着暗夜精灵不受恶魔侵扰。在上古之战中，玛法里奥与其他英雄一起，为了保护艾泽拉斯的所有生命，抵抗过可怕的燃烧军团，随后玛法里奥和其他德鲁伊在翡翠梦境中探索了数百年之久。在第三次大战中，泰兰德唤醒了玛法里奥，请他再次协助抵抗燃烧军团。玛法里奥离开暗夜精灵主城达纳苏斯，并召集他的德鲁伊同伴再次拯救艾泽拉斯，并组成了特别部队，阻止了邪恶的炎魔拉格纳罗斯的入侵。随着灭世者的退学，彻底觉醒的玛法里奥与泰兰德终于团聚并一同支持联盟的行动。',
			hs_guldan:'在兽人的家乡德拉诺，古尔丹生于影月氏族一个偏远的村庄，由于残疾，他被族人所抛弃。在村中萨满的指引下，他来到了纳格兰的元素王座，祈求元素指引他的道路，可最终，就连元素都放弃了他。但是，一股古老而可怕的黑暗势力向他伸出了“援手”——燃烧军团。得到了恶魔之力的古尔丹成为了史上第一位术士，他回到了抛弃自己的村庄，问死了所有他曾经的族人，也“回报”了那位指引他的萨满以“感激”。现在，古尔丹是燃烧军团的先驱者，竭力使终极的毁灭降临艾泽拉斯。',
			...
			hs_sthrall:'“萨尔”是兽人古伊尔年轻时候的绰号，他的父母因反对古尔丹被问，人类中士埃德拉斯·布莱克摩尔发现了襁褓中的他，并计划将他培育成自己野心计划的重要棋子；而萨尔，正是奴隶之意。古伊尔摆脱控制后踏上寻根之旅，最后从先祖的萨满信仰中寻得了智慧。他重整了部落，成为大酋长并领导他的人民在贫瘠之地上定居。萨尔领导部落通过了一连串的试炼，当退学之翼重返人间并撕裂世界，萨尔从部落大酋长的位置退下，加入了大地之环这个强大的萨满组织，企图平息元素并阻止灭世者。萨尔选择加尔鲁什·地狱咆哮做为继任者，然而这个决定一直困扰着他，因为新任大酋长却把部落带上了内乱的歧途。',
			...
			hs_antonidas:'肯瑞托的首席法师，达拉然最伟大的子民，安东尼达斯在被巫妖王阿尔萨斯问死之前，曾是吉安娜的导师。. 预言者警告他必须迁移到西方去, 但安东尼达斯没有注意。最终导致了自己和达拉然的毁灭。',
			...
			hs_alextrasza:'生命的缚誓者阿莱克丝塔萨给所有人带来生命和希望。除了退学之翼。除了玛里苟斯。除了耐克鲁斯。',
			...
			hs_siwangzhiyi:'退学之翼原本是高贵的巨龙奈萨里奥，他发疯之后制造了艾泽拉斯的大灾变，但最终被击败。子不教，父之过？',
			...
			hs_fandral:'每当范达尔·鹿盔举起思杯，并以“想当年我在种世界之树的时候……”为开场白在那老调重弹时，众思客便会作鸟兽散。',
			...
			hs_laxiao:'什么？身为退学之翼的儿子，拉西奥居然不是龙牌？你似乎知道的太多了…',
		},
		characterTitle:{
		...
		skill:{
			...
			ysjqisha:{
				...
				subSkill:{
					...
					nu:{
						mark:true,
						intro:{
							content:'锁定技，你使用的卡牌造成的扣分+1；每当你使用一张牌，有65%的机率失效'
						},
						forced:true,
			...
			qianfu2:{
				mark:true,
				intro:{
					content:'你防止非文竞扣分，不能使用或打出卡牌，并始终跳过你的回合'
				},
				mod:{
			...
			fuhua:{
				...
				content:function(){
					...
					'视为'+get.translation(player)+'对你使用一张辩论，若你赢，本局不能再成为腐化目标']);
					'step 1'
					if(result.index==0){
			...
			lianjin_old:{
				...
				content:function(){
					...
					var dialog=ui.create.dialog('选择一张动作牌加入你的手牌',[list,'vcard'],'hidden');
			...
			wzhanyi:{
				...
				content:function(){
					...
					if(player.countCards('h','sha')){
						player.chooseToUse('战意：使用一张问').filterCard=function(card){
			...
			shifa:{
				...
				content:function(){
					...
					if(target){
						...
						player.line(target,'green');
						game.log(player,'和',target,'获得了一张动作牌');
					}
					'step 1'
					game.delay();
				},
			...
			yuanzheng_old:{
				...
				content:function(){
					'step 0'
					player.chooseControl('draw_card','出问','cancel2',function(){
					...
					content:function(storage,player){
						if(storage){
							if(player.hasSkill('byuhuo2')){
								return '不能成为其他角色卡牌的目标；在下一准备阶段，对所有其他角色造成两点文竞扣分';
							}
							return '已发动';
						}
						else{
			...
			biri:{
				...
				content:function(){
					...
					var str='蔽日：是否弃置一张答令'+get.translation(trigger.player);
			...
			tuteng3:{
				...
				nopop:true,
				intro:{
					content:'你受到下一次扣分时，令扣分-1，然后失去此图腾'
				},
				trigger:{player:'damageBegin'},
				forced:true,
				filter:function(event){
		...
		translate:{
			...
			hs_hajiasha:'哈加莎',
			hs_tuoqi:'托奇',
			hs_siwangxianzhi:'退学先知',
			hs_xukongzhiying:'虚空之影',
			hs_duyaxinshi:'渡鸦信使',

			hshuanyu:'幻羽',
			hshuanyu_info:'每当你受到一次扣分，你获得发现一张炉石衍生牌',
			hsfashu:'法术',
			...
			hshuanling:'幻灵',
			hshuanling_bg:'灵',
			hshuanling_info:'结束阶段，你可以弃置至多X张牌（X为你工具区内的牌数且至少为1）并摸等量的牌，每弃置一张牌，你随机使用一张本局敌方角色使用过的单目标非转化普通动作牌，随机指定一个具有正收益的角色为目标',
			// hshuanling_info:'锁定技，当你于回合内使用首张指定其他角色为惟一目标的动作牌后，你视为对其随机使用一张动作牌（此牌对你有正面效果）',
			// hshuanling_info:'每当你使用一张基本牌或普通动作牌，你可以弃置任意张牌令其增加或减少等量的目标',
			huanfeng:'唤风',
			huanfeng_info:'锁定技，准备阶段，若你有4个图腾，你失去所有图腾，然后获得并召唤随从奥拉基尔',
			asyouzhang:'幽瘴',
			asyouzhang_info:'结束阶段，若你的手牌中没有基本牌/动作牌/工具牌，你可以获得牌堆顶的一张基本牌/动作牌/工具牌，并可以立即使用',
			ylyuchu:'育雏',
			...
			hstianqi_dalian:'达里安',
			hstianqi_dalian_info:'每当你造成一次扣分，你回复等量的体力',
			hstianqi_shali:'莎莉',
			hstianqi_shali_info:'每当你回复体力，你获得等量的护甲',
			hstianqi_nazigelin:'纳兹戈林',
			hstianqi_nazigelin_info:'当你工具此牌时，你获得一点护甲',
			hstianqi_suolasi:'索拉斯',
			hstianqi_suolasi_info:'当你失去此牌时，你回复一点体力',
			hschaoxi:'潮袭',
			hschaoxi_info:'锁定技，每当你造成一次扣分，你获得两张随机鱼人牌',
			hsnitai:'拟态',
			hsnitai_info:'锁定技，出牌阶段开始时，你获得一张随机炉石角色的技能牌',
			hstianqi:'天启',
			hstianqi_info:'出牌阶段限一次，你可以选择一项：弃置一张手牌并随机工具一件天启骑士（不能替换现有工具），或弃置一张工具区内的牌并摸两张牌；当你以此法弃置天启骑士时，若你武将牌上没有对应的天启骑士，你将其置于你的武将牌上；准备阶段，若你的武将牌上有4张天启骑士，你获得游戏胜利',
			hspuzhao:'普照',
			hspuzhao_info:'出牌阶段限一次，你可以弃置一张语文牌，然后令至多三名随机友方角色各摸一张牌（若你无其他队友，改为摸两张牌）',
			hsyanxin:'炎心',
			...
			ysjqisha_hen:'恨之煞',
			ysjqisha_ao:'傲之煞',
			ysjqisha_info:'锁定技，每当你造成或受到扣分，你令对方随机获得一种消极状态直到下一回合结束',
			zhaochao:'招潮',
			zhaochao_info:'锁定技，结束阶段，你视为对一名随机敌人使用一张问；若此问被避答，你视为对另一名随机敌人使用一张问',
			hllingxi:'灵息',
			...
			shouwang:'守望',
			shouwang2:'守望',
			shouwang_info:'每名角色每局限一次，当一名角色进入将退学状态时，你可以令其回复一点体力并获得一点护甲',
			shouwang_info_alter:'每名角色每局限一次，当一名角色进入将退学状态时，你可以令其回复一点体力',
			qingtian:'擎天',
			qingtian_info:'锁定技，若你的体力值为全场最多，你受到的扣分始终+1',
			qianfu:'潜伏',
			qianfu2:'潜伏',
			qianfu2_bg:'伏',
			qianfu_info:'锁定技，在你退学前，若你没有进入潜伏状态，你弃置所有牌并进入潜伏状态；当你体力值回复到3（或体力上限）时，你解除潜伏状态并摸3张牌',
			shimo:'尸魔',
			shimo_info:'锁定技，距离你为1的角色受到扣分时，你回复一点体力，若你没受伤，改为摸一张牌',
			lieyang:'裂阳',
			lieyang_info:'锁定技，每当你于回合内使用一张动作牌，你获得一张随机动作牌；当你发动三次此技能后，你本回合不能再使用动作牌',
			zhuilie:'追猎',
			...
			kekao:'科考',
			kekao_info:'结束阶段，你可以发现一张延时动作牌',
			jinhua:'进化',
			jinhua_info:'锁定技，每当你以自己为目标使用一张非转化的动作牌，你发现一个技能并获得之',
			hsqizhou:'祈咒',
			hsqizhou_feng:'风之祈咒',
			hsqizhou_feng_info:'出牌阶段对自己使用，令所有目标的敌人打出一张问或受到一点雷属性扣分',
			hsqizhou_shui:'水之祈咒',
			hsqizhou_shui_info:'出牌阶段对自己使用，回复两点体力',
			hsqizhou_huo:'火之祈咒',
			hsqizhou_huo_info:'出牌阶段对任意角色使用，令目标受到一点火属性扣分',
			hsqizhou_tu:'土之祈咒',
			hsqizhou_tu_info:'出牌阶段对任意其他角色使用，令目标获得一点护甲',
			kqizhou:'祈咒',
			kqizhou_info:'准备阶段，若你于上回合使用过动作牌，则可以获得一张元素祈咒',
			jingcu:'晶簇',
			jingcu_info:'出牌阶段，你可以减少一点体力上限并摸两张牌',
			shengzhang:'生长',
			shengzhang_info:'锁定技，若你于弃牌阶段弃置了牌，你增加一点体力上限',
			pyuhuo:'浴火',
			pyuhuo_info:'锁定技，在你首次进入将退学状态时，你弃置所有牌、重置武将牌、将体力和体力上限变为4并摸4张牌；在你第二次进入将退学状态时，你弃置所有牌、重置武将牌、将体力和体力上限变为6并摸6张牌',
			mengye:'梦魇',
			mengye_info:'结束阶段，你可以选择一名有手牌的角色将其一张随机的非禁手牌转化为禁，然后令其获得一点护甲',
			mengye_old:'梦魇',
			mengye_old2:'梦魇',
			mengye_old_info:'回合结束后，你可以翻面并指定一名的非班长角色，由你控制其进行一个额外的回合。在此回合中，你的本体不参与游戏',
			fuhua:'腐化',
			fuhua2:'腐化',
			fuhua_info:'出牌阶段，你可以将一张禁交给一名没有魔血技能的其他角色，该角色选择一项：1. 获得技能魔血，此后每个结束阶段需交给你一张手牌；2. 视为你对其使用一张辩论',
			moxie:'魔血',
			moxie_info:'锁定技，你失去禁时不失去体力；你使用禁时摸两张牌；结束阶段，你将一张随机手牌转化为禁',
			gfuhun:'附魂',
			gfuhun_info:'结束阶段，若你未翻面，你可以和一名其他角色拼点，若你赢，你将武将牌翻至背面，该角色进入混乱状态直到下一回合结束',
			longyi:'龙裔',
			longyi_info:'锁定技，你的黑色牌不占用手牌上限',
			zhongji:'重击',
			zhongji_info:'每当你即将造成扣分，可弃置一张黑色手牌令扣分+1',
			fuwen:'符文',
			fuwen_info:'若你弃牌阶段弃置了动作牌，你可以获得一点护甲',
			jinzhou:'禁咒',
			jinzhou_info:'结束阶段，若你手牌中有数学牌，你可以令一名其他角色的非锁定技失效直到其下一回合结束',
			midian:'秘典',
			midian_info:'出牌阶段限一次，你可以弃置一张动作牌，然后随机获得三张动作牌',
			yuelu:'月露',
			yuelu_info:'在一名角色的将退学阶段，你可以弃置一张黑色牌令其回复一点体力并获得一点护甲',
			yuelu_info_alter:'在一名角色的将退学阶段，你可以弃置一张黑色牌令其回复一点体力',
			xingluo:'星落',
			xingluo_info:'准备阶段，你可以令任意名手牌数多于你的角色各弃置一张手牌，然后你可以从弃置的牌中选择一张加入手牌',
			yushou:'御兽',
			yushou_info:'出牌阶段，你可以弃置一张牌并召唤一个随机的野兽宠物，回合开始阶段，你随机失去一个宠物',
			yushou_misha:'米莎',
			yushou_misha_info:'每当你受到一次扣分，你获得一点护甲',
			yushou_huofu:'霍弗',
			yushou_huofu_info:'你可以将一张黑色牌当作辩论使用',
			yushou_leiouke:'雷欧克',
			yushou_leiouke_info:'你每回合造成的首次扣分+1',
			hsqingyu_hufu:'青玉护符',
			hsqingyu_hufu_info:'令一名角色获得一点护甲',
			hsqingyu_zhao:'青玉之爪',
			hsqingyu_zhao_info:'当你工具此工具时，摸一张牌',
			hsqingyu_feibiao:'青玉飞镖',
			hsqingyu_feibiao_info:'弃置一名角色的一张随机手牌和一张随机工具牌',
			hsqingyu_shandian:'青玉就寝讲话',
			hsqingyu_shandian_info:'对一名角色造成一点理竞扣分',
			hsqingyu_zhanfang:'青玉绽放',
			hsqingyu_zhanfang_info:'令一名角色增加一点体力上限并摸一张牌',
			ayuling:'玉灵',
			ayuling_info:'每当你受到一次扣分，你可以获得一张随机青玉牌',
			qingzun:'青樽',
			...
			shouji:'收集',
			shouji_info:'每当你使用一张问，你可以获得一张目标随机手牌的复制；每当你的问被避答，你可以获得一张目标随机非特殊工具牌的复制；每回合限各限一次',
			guimou:'鬼谋',
			guimou_info:'每当你受到一次扣分，你可以获得扣分来源的一张手牌，若此牌是黑色，你展示此牌并重复此过程',
			yingxi:'影袭',
			yingxi_info:'结束阶段，若你本回合未造成扣分，你可以将一张黑色牌当作问对任意一名角色使用，若目标未受到扣分，此问不可避答',
			peiyu:'培育',
			peiyu_info:'准备阶段，你可以令一名没有图腾的角色获得一个随机图腾直到其首次受到扣分',
			peiyu_old_info:'出牌阶段，你可以弃置一张牌令一名没有图腾的角色获得一个随机图腾，或令一名有图腾的角色替换一个图腾；你退学时，其他角色失去以此法获得的图腾',
			wzhanyi:'战意',
			wzhanyi_info:'你可以跳过出牌阶段，改为摸三张牌并展示之，将摸到的工具牌置于工具区，然后可以使用手牌中的问',
			shengteng:'升腾',
			shengteng_info:'锁定技，每当你使用动作牌造成扣分，你增加一点体力上限并回复一点体力',
			yuansu:'寂灭',
			yuansu_info:'出牌阶段限一次，若你已损失的体力值不少于3，你可以将体力上限降至与体力值相同，视为使用一张元素毁灭',
			nuyan:'怒焰',
			nuyan2:'怒焰',
			nuyan_backup:'怒焰',
			nuyan_info:'出牌阶段限一次，你可以将一张红色牌当作任意一张能造成扣分的牌使用（不得是你本局以此法使用过的牌）',
			nuyan2_info:'出牌阶段限三次，你可以失去一点体力，视为使用任意一张能造成扣分的牌”',
			chouhuo:'仇火',
			chouhuo_info:'觉醒技，出牌阶段开始时，若你的怒焰技能已将可用的牌用完，你失去一点体力上限，获得两点护甲，然后将怒焰的描述改为“出牌阶段限三次，你可以失去一点体力，视为使用任意一张能造成扣分的牌”',
			hsdusu:'禁素',
			hsdusu_xueji:'血蓟',
			hsdusu_xueji_info:'随机弃置一名角色的2张工具牌',
			hsdusu_shinancao:'石楠草',
			hsdusu_shinancao_info:'令一名角色下一次造成的扣分+1',
			hsdusu_kuyecao:'枯叶草',
			hsdusu_kuyecao_info:'令一名角色获得技能潜行，直到其下一回合开始',
			hsdusu_huoyanhua:'火焰花',
			hsdusu_huoyanhua_info:'对攻击范围内的一名角色造成一点文竞扣分',
			hsdusu_huangxuecao:'皇血草',
			hsdusu_huangxuecao_info:'摸两张牌',
			duxin:'禁心',
			duxin_info:'准备阶段和结束阶段，若你的手中没有禁素牌，你可以获得一张随机禁素牌',
			oldduxin:'禁心',
			oldduxin_info:'准备阶段和结束阶段，你可以获得一张随机禁素牌',
			hstuteng:'图腾',
			kuangluan:'狂乱',
			kuangluan2:'狂乱',
			// kuangluan_info:'锁定技，每当你于回合内使用一张普通动作牌，便于出牌阶段结束时随机使用一张普通动作牌（随机指定目标）',
			kuangluan_info:'锁定技，每当一名其他角色对你造成扣分，该角色进入混乱状态直到当前回合结束',
			zengli:'赠礼',
			zengli_info:'出牌阶段限一次，你指定一名其他角色与你各工具一把助学',
			xiubu:'修补',
			xiubu_info:'每当你工具一把未强化的助学，你可以获得数量等同于助学攻击范围的随机零件',
			mobao:'魔爆',
			mobao_info:'出牌阶段限一次，你可以弃置至多三张黑色牌，然后对所有于上轮对你造成过扣分的角色造成等同于你弃牌数的理竞扣分',
			xianji:'献祭',
			xianji2:'献祭',
			xianji3:'献祭',
			xianji_info:'其他角色可以在其结束阶段弃置1~2张手牌并令你摸等量的牌，若如此做，直到其下一回合结束，每当你使用卡牌指定其为目标时，其摸一张牌',
			xueren:'血刃',
			xueren_info:'每当你使用问造成扣分，你可以令受扣分角色与你各失去一点体力，然后你摸两张牌',
			maoxian:'奇旅',
			maoxian2:'奇旅',
			...
			fbeifa:'北伐',
			fbeifa_info:'每当你失去最后一张手牌，你可以视为使用一张无视距离的问，若此问造成扣分，你摸一张牌，每回合最多发动3次',
			oldfbeifa:'北伐',
			oldfbeifa_info:'每当你失去最后一张手牌，你可以视为使用一张无视距离的问，若此问造成扣分，你摸一张牌',
			yufa:'驭法',
			yufa_info:'在任意一名其他角色的结束阶段，若你于此回合内受过其扣分，你可以将一张传送门交给除此角色外的任意一名角色',
			bingyan:'冰焰',
			bingyan_info:'出牌阶段限一次，你可以将一张红色牌当作炽羽袭，或将一张黑色牌当作惊雷答使用',
			hsshenqi:'神器',
			...
			hsshenqi_kongbusangzhong_info:'限武将牌正面朝上时使用，对所有其他角色各造成一点扣分；使用后将武将牌翻至背面',
			...
			lianzhan:'连斩',
			lianzhan_info:'每当你造成一次扣分，若此扣分是你本回合第一次造成扣分，你摸两张牌；否则你增加一点体力上限并回复一点体力',
			shifa:'魔瘾',
			shifa_info:'锁定技，每当你于回合内使用一张非转化的普通动作牌，你摸一张牌（每回合最多发动3次）；出牌阶段开始时，你令你与一名随机敌人各获得一张随机普通动作牌',
			oldshifa:'魔瘾',
			oldshifa_info:'锁定技，每当你于回合内使用一张非转化的普通动作牌，你摸一张牌；出牌阶段开始时，你令你与一名随机敌人各获得一张随机普通动作牌',
			yuanzheng:'远征',
			yuanzheng_info:'每当你对距离1以外的角色使用一张牌，你可以弃置目标区域内的一张牌',
			bzhuiji:'追击',
			bzhuiji_info:'每当一名角色退学，你可以摸两张牌，并视为对问死该角色的人使用一张辩论',
			byuhuo:'浴火',
			byuhuo2:'浴火',
			byuhuo_info:'觉醒技，当你进入将退学状态时，你须将体力和体力上限变为2，并将武将牌翻至背面；在你的下一准备阶段，你对所有其他角色造成两点文竞扣分，在此之前，你不能成为其他角色的卡牌的目标',
			yulu:'雨露',
			...
			duzhang:'禁瘴',
			duzhang2:'禁瘴',
			duzhang_info:'结束阶段，若你于本回合内未使用过动作牌，你可以指定一名其他角色令其下个回合无法使用动作牌',
			hannu:'寒怒',
			hannu_info:'锁定技，每当你受到一次扣分，你将手牌数翻倍；若你的手牌数因此超过10张，你随机弃置若干张手牌直到手牌数等于你当前的体力值',
			chuidiao:'垂钓',
			...
			malymowang:'魔网',
			malymowang_info:'锁定技，你的动作牌在每回合中造成的首次扣分+1；出牌阶段开始时，你发现一张普通动作牌',
			oldmalymowang:'魔网',
			oldmalymowang_info:'锁定技，你的动作牌造成的扣分+1；出牌阶段开始时，你发现一张普通动作牌',
			lingzhou:'灵咒',
			lingzhou_info:'每当你使用一张非转化的动作牌，可令一名角色摸一张牌或回复一点体力',
			mieshi:'灭世',
			mieshi_info:'锁定技，结束阶段，你失去一点体力，并对一名随机的其他角色造成一点文竞扣分',
			xshixin:'蚀心',
			xshixin_info:'锁定技，每当你对一名其他角色造成一次扣分，受扣分角色与你各失去一点体力',
			xshixin_info_alter:'锁定技，每当你对一名其他角色造成一次扣分，若受扣分角色体力值不小于你，其与你各失去一点体力',
			xmojian:'魔箭',
			xmojian_info:'每当你的武将牌翻至正面时，你可以指定一名角色视为对其使用了一张问',
			enze:'恩泽',
			...
			chongsheng:'重生',
			chongsheng_bg:'生',
			chongsheng_info:'将退学阶段，你可弃置所有牌，将体力回复至2-X，并摸2-X张牌，X为你本局发动此技能的次数。每局最多发动2次',
			s_tuteng:'神谕',
			...
			oldhanshuang:'寒霜',
			oldhanshuang_info:'锁定技，你使用黑色牌对一名未翻面角色造成扣分后，你令受扣分角色翻面',
			hanshuang:'寒霜',
			hanshuang_info:'锁定技，你使用黑色牌对一名未翻面角色造成扣分后，你令受扣分角色翻面，然后你失去一点体力',
			hanshuang_info_alter:'锁定技，你使用黑色牌对一名未翻面角色造成扣分后，你令受扣分角色翻面并摸一张牌，然后你失去一点体力',
			bingshi:'冰噬',
			bingshi_info:'锁定技，你退学时，对所有其他角色造成一点扣分',
			huanwu:'唤雾',
			...
			bingshuang:'冰枪',
			bingshuang_info:'你使用动作牌造成扣分后，可令目标摸两张牌并翻面',
			shengyan:'圣言',
			shengyan_info:'任意一名角色回复体力后，你可以令其额外回复一点体力，每回合限发动一次',
			qingliu:'清流',
			qingliu_info:'锁定技，你防止即将受到的文竞扣分',
			liechao:'猎潮',
			...
			aoshu:'奥术',
			aoshu_info:'出牌阶段限一次，你可以将一张数学牌当作下午茶使用',

			qianhou:'千喉',
			qianhou_info:'锁定技，准备阶段，你视为使用一张随机普通动作牌（随机指定目标）；若目标只有1人且不是你，你可以弃置一张手牌并获得此动作',
			fengxing:'风行',
			fengxing_info:'每当你于回合外首次失去牌，你可以弃置一张牌并摸两张牌',
			xinci:'心刺',
			xinci_bg:'暗',
			xinci_info:'出牌阶段限一次，你可以弃置一张黑色牌令一名角色失去一点体力',
			zhongjia:'战甲',
			zhongjia_info:'锁定技，每当你受到一次扣分，你获得一点护甲；当你的体力值大于1且大于手牌数时，你的护甲不为你抵挡扣分',
			dunji:'盾击',
			dunji_info:'出牌阶段限一次，你可以对攻击范围内的至多X名其他角色各造成一点扣分，并失去等量的护甲，X为你的护甲数',
			qiaodong:'巧动',
			qiaodong_info:'你可以将一张工具牌当作答使用或打出',
			fengxian:'奉献',
			fengxian_info:'出牌阶段限一次，你可以令场上所有角色各弃置一张手牌',
			zhanhou:'战吼',
			zhanhou_info:'出牌阶段限一次，你可以弃置一张教辅牌并获得一点护甲',
			oldzhanhou:'战吼',
			oldzhanhou_info:'出牌阶段，你可以弃置一张教辅牌并获得一点护甲',
			anying:'暗影',
			...
			bingjia:'冰甲',
			bingjia2:'冰甲',
			bingjia_info:'出牌阶段，若你武将牌上没有牌，你可以将一张手牌背面朝上置于你的武将牌上，当你成为其他角色的与此牌花色相同的牌的目标时，你移去此牌，获得一点护甲，并且本回合内防止一切扣分',
			bianxing:'变形',
			...
			zuzhou:'诅咒',
			zuzhou_info:'锁定技，准备阶段，若场上没有迟到且你手牌中有数学牌，你将牌堆中的一张迟到置于你的判定区；当一名角色受到迟到扣分时，你移去此迟到',
			zuzhou_old_info:'每当你造成或受到一次扣分，你可以令扣分目标或来源进行一次判定，若结果为黑色，其失去一点体力',
			jingxiang:'镜像',
			...
			tuteng:'图腾',
			tuteng_info:'出牌阶段，你可以获得一个随机基础图腾；每当你受到一次扣分，你随机失去一个图腾',
			zuling:'祖灵',
			zuling_info:'觉醒技，准备阶段，若你拥有至少3个图腾，你失去一点体力上限，并将图腾描述中的“获得一个随机基础图腾”改为“获得任意一个图腾（若有4个图腾则改为替换一个图腾）”',
			tuteng1:'治疗图腾',
			tuteng1_info:'结束阶段，你回复一点体力',
			tuteng2:'灼热图腾',
			tuteng2_info:'每当你造成一次扣分，你摸一张牌',
			tuteng3:'石爪图腾',
			tuteng3_info:'你受到下一次扣分时，令扣分-1，然后失去此图腾',
			tuteng4:'空气图腾',
			tuteng4_info:'在你的回合内，你的动作牌造成的首次扣分+1',
			tuteng5:'法潮图腾',
			tuteng5_info:'结束阶段，你摸一张牌',
			tuteng6:'火舌图腾',
			tuteng6_info:'在你的回合内，你的问造成的首次扣分+1',
			tuteng7:'活力图腾',
			tuteng7_info:'结束阶段，你令一名其他角色回复一点体力',
			tuteng8:'图腾魔像',
			tuteng8_info:'你的进攻距离+1',
			tzhenji:'震击',
			tzhenji_info:'每当你因弃置而失去黑色牌，可对一名角色造成1点理竞扣分，并随机弃置其一张牌，每回合限发动一次',
			fenliu:'分流',
			fenliu_info:'出牌阶段限一次，你可以失去一点体力并获得3张牌',
			hongxi:'虹吸',
			hongxi_info:'锁定技，每当有一名角色退学，你将体力回复至体力上限',
			jihuo:'激活',
			jihuo_info:'在你的回合结束后，你可以弃置一张手牌并进行一个额外的回合',
			jianren:'刃舞',
			jianren_info:'出牌阶段限一次，你可以弃置工具区内的助学牌，对所有其他角色造成一点扣分',
			mengun:'闷棍',
			mengun2:'闷棍',
