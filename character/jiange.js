...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
			...
			zhinang:{
				...
				content:function(){
					...
					if(event.cards2.length==0){
						...
						var dialog=ui.create.dialog('将三张牌中的动作牌或工具牌交给一名角色','hidden');
		...
		translate:{
			...
			jizhen:'激阵',
			xuanlei:'玄雷',
			xuanlei_info:'锁定技，准备阶段，你令所有判定区内有牌的其他角色受到1点理竞扣分',
			sfanshi:'反噬',
			sfanshi_info:'锁定技，结束阶段，你失去1点体力',
			konghun:'控魂',
			konghun_info:'出牌阶段开始时，若你的体力值不大于1（场上存活角色数不小于6时改为2），你可以对至多X名角色各造成1点理竞扣分，然后你恢复等量体力，X为场上其他存活角色数的一半（向下取整且至多为4）',
			...
			biantian_info:'锁定技，准备阶段，你进行一次判定，若为红色，你可以选择至多三名角色进入“狂风”状态直到你的下一回合开始，若为数学，直到下个回合开始前，你处于“大雾”状态',
			jingmiao_info:'每当有一名其他角色使用我很优秀，你可以弃置其一张牌',
			zhinang_info:'准备阶段，你可以亮出牌堆顶的三张牌，你可以将其中动作或工具牌交给一名角色',
			tianyu_info:'结束阶段，你可以将任意名未横置的其他角色横置',
			juechen:'绝尘',
			juechen_info:'每当你使用一张问，可以弃置一名其他角色的一张牌（不能是问的目标）',
			chiying:'持盈',
			chiying_info:'每当一名角色受到多于1扣分时，你可以令其防止其余扣分，然后令扣分来源摸一张牌',
			jingfan:'惊帆',
			jingfan2:'惊帆',
