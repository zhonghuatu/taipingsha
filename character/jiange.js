...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			jizhen:'激阵',
			xuanlei:'玄校级',
			xuanlei_info:'锁定技，准备阶段，你令所有判定区内有牌的其他角色受到1点校级电扣分',
			sfanshi:'反噬',
			sfanshi_info:'锁定技，结束阶段，你失去1点体力',
			konghun:'控魂',
			konghun_info:'出牌阶段开始时，若你的体力值不大于1（场上存活角色数不小于6时改为2），你可以对至多X名角色各造成1点校级电扣分，然后你恢复等量体力，X为场上其他存活角色数的一半（向下取整且至多为4）',
			...
			biantian_info:'锁定技，准备阶段，你进行一次判定，若为文科，你可以选择至多三名角色进入“狂风”状态直到你的下一回合开始，若为数学，直到下个回合开始前，你处于“大雾”状态',
