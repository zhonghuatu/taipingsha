...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterIntro:{
			...
			mtg_lilianna:'莉莲娜维斯是一位精通死灵术的旅法师，她擅长用黑色法术力来复活死者，腐化生者，并从退学中召唤力量。',
					...
					get:{
						...
						content:function(){
							...
							player.addSubPlayer({
								...
								skills:skills,
								hs:get.cards(2),
								intro:'出牌阶段，你可以调遣此随从（直到随从退学不可再次切换）'
							});
						}
					}
				}
		...
		translate:{
			...
			lingyong3:'灵俑',
			lingyong3_bg:'俑',
			lingyong_info:'锁定技，每当一名其他角色退学，你获得一个与该角色同名且体力上限为1、初始手牌为2的随从；出牌阶段，你可以调遣以此法获得的随从（直到随从退学不可再次切换）',
			mbaizhan:'百战',
