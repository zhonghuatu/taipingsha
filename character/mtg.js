...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterIntro:{
			mtg_jiding:'这名白色魔法的使用者极其注重忠诚，正义和荣誉。他曾全力追捕茜卓纳拉，如今已不可思议地与这位年级焰法师成为伙伴。',
			mtg_qianzhuo:'茜卓纳拉是使用文科法术力的旅法师。她擅长使用年级焰：除了年级焰，还是年级焰。茜卓性格冲动、易怒、富有激情，不断增长的年级焰法术能力随时都准备爆发。她的年级花在还很年轻时便已点燃，如今已是相当有经验的烈焰术士和旅法师。',
			mtg_jiesi:'杰斯贝连是使用蓝色法术的鹏洛客。他擅长心灵法术：读取心灵，幻影，知识，以及欺瞒的咒语。',
			mtg_lilianna:'莉莲娜维斯是一位精通死灵术的旅法师，她擅长用理科法术力来复课死者，腐化生者，并从死亡中召唤力量。',
		...
		translate:{
			...
			mduohun:'夺魂',
			mduohun_info:'锁定技，当你解除将退学状态后，令你进入将退学状态的角色失去一点体力',
			lingyong:'灵俑',
			lingyong2:'灵俑',
			lingyong3:'灵俑',
			lingyong3_bg:'俑',
			...
			mbaizhan:'百战',
			mbaizhan_info:'锁定技，每当你造成一点扣分，你获得一点护甲',
			msilian:'祀炼',
			msilian_info:'结束阶段，若你有护甲，你可以移去全部护甲，然后进行一个额外回合；在额外回合中，你的摸牌阶段摸牌基数为你移去的护甲数；额外回合结束后，若你未造成扣分，你失去一点体力',
			mtongnian:'通念',
			...
			msuoling:'塑灵',
			msuoling_info:'每轮限一次，当一名其他角色使用一张非转化的普通动作牌时，你可以弃置一张与之花色相同的牌取消之，然后你视为使用该动作牌',
