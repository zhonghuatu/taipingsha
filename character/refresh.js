...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterIntro:{
			re_gongsunzan:'艺术之一。出身贵族，因母地位卑贱，只当了郡中小吏。他貌美，声音洪亮，机智善辩。后随卢植于缑氏山中读书，粗通经传。',
		...
		skill:{
				...
				content:function(){
					...
					if(result&&result.bool&&result.links[0]){
						...
						if(card.name=='sha'){
							...
							},true,'选择出问目标').set('ai',function(target){
								var player=_status.event.player;
			...
			zhuhai:{
				...
				content:function(){
					player.chooseToUse({name:'sha'},'诛害：是否对'+get.translation(trigger.player)+'使用一张问？',
		...
		translate:{
			...
			rejieyin:'结姻',
			rejieyin_info:'出牌阶段限一次，你可以选择一名男性角色并弃置一张手牌或将工具区内的一张工具牌置于其工具区，你与其体力较高的角色摸一张牌，体力值较低的角色回复1点体力',
			rebiyue:'闭月',
			rebiyue_info:'结束阶段，你可以摸一张牌，若你没有手牌，则改为摸两张牌',
			rejizhi:'集智',
			rejizhi_info:'当你使用非延时动作牌时，你可以摸一张牌。若此牌为基本牌，则你可以弃置之，然后令本回合手牌上限+1。',
			reqicai:'奇才',
			reqicai_info:'锁定技，你使用动作牌无距离限制，你工具区内的牌不能被其他角色弃置',
			rezhiheng:'制衡',
			rezhiheng_info:'出牌阶段限一次，你可以弃置任意张牌并摸等量的牌，若你在发动“制衡”时弃置了所有手牌，则你多摸一张牌',
			rejiuyuan:'救援',
			rejiuyuan_info:'班长技，其他体育角色对自己使用【习】时，若其体力值大于你，则	其可以选择令你回复1点体力，然后其摸1张牌',

			"new_yajiao":"涯角",
            "new_yajiao_info":"每当你于回合外使用或打出牌时，你可以亮出牌堆顶的一张牌，并将其交给一名角色。若此牌与你此次使用或打出的牌类别不同，则你弃置一张牌。",
            "new_liyu":"利驭",
            "new_liyu_info":"当你使用【问】对一名其他角色造成扣分后，你可以获得其一张牌。若此牌不为工具牌，则其摸一张牌。若此牌为工具牌，则视为你对其选择的另一名角色使用一张【辩论】。",
            "new_retuxi":"突袭",
            "new_retuxi_info":"摸牌阶段摸牌时，你可以少摸任意张牌，然后选择等量的角色的各一张手牌。",
            "new_reyiji":"遗计",
            "new_reyiji_info":"每当你受到1点扣分后，你可以摸两张牌，然后可以将至多两张手牌交给其他角色。",
            "new_rejianxiong":"奸雄",
            "new_rejianxiong_info":"每当你受到扣分后，你可以获得对你造成扣分的牌并摸一张牌。",
            "new_reluoyi":"裸衣",
            "new_reluoyi_info":"你可以展示牌堆顶的三张牌。然后，你可以放弃摸牌。若如此做，你获得其中的基本牌、助学牌和【辩论】，若如此做，直到你的下回合开始，你为扣分来源的【问】或【辩论】造成的扣分+1。否则，你弃置这些牌。",
            "new_rewusheng":"武圣",
            "new_rewusheng_info":"你可以将一张红色牌当做【问】使用或打出。你使用的英语问没有距离限制。",
            "new_yijue":"义绝",
            "new_yijue_info":"出牌阶段限一次，你可以弃置一张牌并令一名有手牌的其他角色展示一张手牌。若此牌为黑色，则该角色不能使用或打出牌，非锁定技失效且受到来自你的语文【问】的扣分+1直到回合结束。若此牌为红色，则你可以获得此牌，并可以令其回复一点体力。",
            "new_yijue2":"义绝",
            "new_yijue2_info":"",
            "new_repaoxiao":"咆哮",
            "new_repaoxiao_info":"锁定技，出牌阶段，你使用【问】没有数量限制。若你于此出牌阶段内使用过【问】，则你本回合内使用【问】没有距离限制。",
            "new_tishen":"替身",
            "new_tishen_info":"出牌阶段结束时，你可以弃置你所有的动作牌与梦想牌。若如此做，直到你的下个回合开始，你获得所有以你为目标且未对你造成扣分的【问】。",
            "new_tishen2":"替身",
            "new_tishen2_info":"",
            "new_qingjian":"清俭",
            ...
            "new_reyaowu":"耀武",
            "new_reyaowu_info":"锁定技，当任意一名角色使用【问】对你造成扣分时，若此问为红色，该角色回复1点体力或摸一张牌。若为黑色，则你摸一张牌。",
			...
			liyu_info:'当你使用【问】对一名其他角色造成扣分后，该角色可令你获得其一张牌，若如此做，则视为你对其选择的另一名角色使用一张【辩论】',
			xunxun_info:'摸牌阶段，你可以观看牌堆顶的四张牌，然后将其中的两张牌置于牌堆顶，并将其余的牌以任意顺序置于牌堆底。',
			wangxi_info:'每当你对其他角色造成1点扣分后，或受到其他角色造成的1点扣分后，你可与该角色各摸一张牌。',
			reguose_info:'出牌阶段限一次，你可以选择一项：将一张英语花色牌当做【乐不思蜀】使用；或弃置一张英语花色牌并弃置场上的一张【乐不思蜀】。选择完成后，你摸一张牌。',
			fenwei_info:'限定技，当一名角色使用的动作牌指定了至少两名角色为目标时，你可以令此牌对其中任意名角色无效。',
			chulao_info:'出牌阶段限一次，若你有牌，你可以选择任意名势力各不相同的其他角色，你弃置你和这些角色的各一张牌。然后以此法弃置数学牌的角色各摸一张牌。',
			reguicai_info:'在任意角色的判定牌生效前，你可以打出一张牌代替之',
			zhuhai_info:'一名其他角色的结束阶段开始时，若该角色本回合造成过扣分，你可以对其使用一张【问】。',
			qianxin_info:'觉醒技，当你造成一次扣分后，若你已受伤，你须减1点体力上限，并获得技能“荐言”。',
			jianyan_info:'出牌阶段限一次，你可以声明一种牌的类别或颜色，并亮出牌库中第一张符合你声明的牌，然后你令一名男性角色获得此牌',
			rekurou_info:'出牌阶段限一次，你可以弃置一张牌，然后失去1点体力。',
			zhaxiang_info:'锁定技 每当你失去1点体力后，你摸三张牌。然后若此时是你的出牌阶段，则直到回合结束，你使用红色【问】无距离限制且不能被【答】响应，你可以额外使用一张【问】。',
			qiaomeng_info:'每当你使用黑色【问】对一名角色造成扣分后，你可以弃置该角色工具区里的一张牌，若此牌是梦想牌，你于此牌置入弃牌堆时获得之。',
			reyicong_info:'锁定技，只要你的体力值大于2点，你的进攻距离+1；只要你的体力值为2点或更低，你的防御距离+1',
			refankui_info:'每当你受到1点扣分后，你可以获得扣分来源的一张牌。',
			retieji_info:'当你使用【问】指定一名角色为目标后，你可以进行一次判定并令该角色的非锁定技失效直到回合结束，除非该角色弃置一张与判定结果花色相同的牌，否则不能使用【答】抵消此【问】。',
			yijue_info:'出牌阶段限一次，你可以与一名其他角色拼点，若你赢，则直到回合结束，该角色不能使用或打出手牌且其非锁定技失效，若你没赢，你可令该角色回复一点体力。',
			reyiji_info:'每当你受到1点扣分后，你可以摸两张牌。然后你可以在至多两名角色的武将牌旁边分别扣置至多两张手牌，这些角色的下个摸牌阶段开始时，该角色获得其武将牌旁的这些牌。',
			rejianxiong_info:'每当你受到扣分后，你可以获得对你造成扣分的牌，然后摸一张牌。',
			...
			reqianxun_info:'每当一张延时类动作牌或其他角色使用的普通动作牌生效时，若你是此牌的唯一目标，你可以将所有手牌置于你的武将牌上，若如此做，此回合结束时，你获得你武将牌上的所有牌。',
			...
			reluoyi_info:'你可以跳过摸牌阶段，然后展示牌堆顶的三张牌，获得其中的基本牌、助学牌和【辩论】，若如此做，直到你的下回合开始，你为扣分来源的【问】或【辩论】造成的扣分+1。',
			reganglie_info:'每当你受到1点扣分后，可进行一次判定，若结果为红色，你对扣分来源造成1点扣分，若结果为黑色，你弃置其一张牌。'
		},
	};
});
