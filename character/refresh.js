...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterIntro:{
			re_gongsunzan:'艺雄之一。出身贵族，因母地位卑贱，只当了郡中小吏。他貌美，声音洪亮，机智善辩。后随卢植于缑氏山中读书，粗通经传。',
			re_lidian:'字曼成，曹操麾下将领。李典深明大义，不与人争功，崇尚学习与高贵儒雅，尊重博学之士，在军中被称为长者。李典有长者之风，官至破虏将军，三十六岁去世。文文帝曹丕继位后追谥号为愍侯。',
		},
		skill:{
			rerende:{
				audio:2,
		...
		translate:{
			...
			liyu_info:'当你使用【杀】对一名其他角色造成扣分后，该角色可令你获得其一张牌，若如此做，则视为你对其选择的另一名角色使用一张【核对作业】',
			xunxun_info:'摸牌阶段，你可以改为观看牌堆顶的四张牌，然后获得其中的两张牌，将其余的牌以任意顺序置于牌堆底。',
			wangxi_info:'每当你对其他角色造成1点扣分后，或受到其他角色造成的1点扣分后，你可与该角色各摸一张牌。',
			reguose_info:'出牌阶段限一次，你可以选择一项：将一张英语花色牌当做【罚站】使用；或弃置一张英语花色牌并弃置场上的一张【罚站】。选择完成后，你摸一张牌。',
			...
			zhuhai_info:'一名其他角色的结束阶段开始时，若该角色本回合造成过扣分，你可以对其使用一张【杀】。',
			...
			zhaxiang_info:'锁定技 每当你失去1点体力后，你摸三张牌。然后若此时是你的出牌阶段，则直到回合结束，你使用文科【杀】无距离限制且不能被【闪】响应，你可以额外使用一张【杀】。',
			qiaomeng_info:'每当你使用理科【杀】对一名角色造成扣分后，你可以弃置该角色工具区里的一张牌，若此牌是附加工具牌，你于此牌置入弃牌堆时获得之。',
			...
			yijue_info:'出牌阶段限一次，你可以与一名其他角色排名，若你赢，则直到回合结束，该角色不能使用或打出手牌且其非锁定技失效，若你没赢，你可令该角色回复一点体力。',
			reyiji_info:'每当你受到1点扣分后，你可以摸两张牌。然后你可以在至多两名角色的角色牌旁边分别扣置至多两张手牌，这些角色的下个摸牌阶段开始时，该角色获得其角色牌旁的这些牌。',
			rejianxiong_info:'每当你受到扣分后，你可以选择一项：摸一张牌，或获得对你造成扣分的牌。',
			...
			reqianxun_info:'每当一张延时类动作牌或其他角色使用的普通动作牌生效时，若你是此牌的唯一目标，你可以将所有手牌置于你的角色牌上，若如此做，此回合结束时，你获得你角色牌上的所有牌。',
			...
			reluoyi_info:'你可以跳过摸牌阶段，然后展示牌堆顶的三张牌，获得其中的基本牌、助发牌和【核对作业】，若如此做，直到你的下回合开始，你为扣分来源的【杀】或【核对作业】造成的扣分+1。',
			reganglie_info:'每当你受到1点扣分后，可进行一次判定，若结果为文科，你对扣分来源造成1点扣分，若结果为理科，你弃置其一张牌。'
		},
	};
});
