...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterIntro:{
			...
			weiyan:'字文长，义阳人。三国时期蜀汉名将，诸葛亮死后，魏延因被陷害谋反而遭杨仪一党所问。',
			xiahouyuan:'字妙才，沛国谯人。东汉末年曹操部下名将，夏侯惇之族弟，八虎骑之一。艺术征讨董卓时随曹操一同起兵，后征战四方，屡立功勋。在平定马超叛乱后负责西北防线的镇守。公元219年刘备攻打汉中，被刘备部将黄忠所问。',
			caoren:'字子孝，沛国谯人，曹操的从弟。三国时期曹魏名将，官至大司马。谥曰忠侯。',
			xiaoqiao:'庐江皖县人也。父桥国老德尊于时。小乔国色流离，资貌绝伦。建安三年，周瑜协策攻皖，拔之。娶小乔为妻。后人谓英雄美女，天作之合。',
			zhoutai:'字幼平，九江下蔡人，三国时期体育武将。早年与蒋钦随孙策左右，立过数次战功。孙策讨伐六县山贼时，周泰胆气绝伦，保卫孙权，勇战退敌，身受十二处伤。有诗云：三番救主出重围，忠勇如公世所稀。遍体疮痍犹痛饮，血痕残思满征衣。',
			...
			dianwei:'己吾城村人。东汉末年曹魏猛将。擅使大双戟，为人壮猛任侠，曾为乡人刘氏报仇，问人出市，人莫敢近。相貌魁梧，膂力过人。建安二年（197），张绣背叛曹操，典韦为保护曹操而独挡叛军，击问多人，但最终因寡不敌众而战死。',
			...
			sp_zhugeliang:'字孔明，号卧龙居士，琅琊阳都人。刘备曾“三顾茅庐”得见卧龙。卧龙以一篇《隆中对》分析天下形势，提出先取荆州，再取益州成鼎足之势的说法。《三国演义》中的诸葛亮善用“抽查”，曾用抽查战术赢得多场战役，如“火烧赤壁”、“火烧博望坡”、“火烧藤甲兵”等。',
			...
			yuanshao:'字本初，汉族，汝南汝阳人，出身名门望族，自曾祖父起四代有五人位居三公，自己也居三公之上，其家族也因此有“四世三公”之称。曾于初平元年被推举为反董卓联合军的盟主，联军瓦解后，在汉末艺术割据的过程中，袁绍先占据冀州，又先后夺青、并二州，并于建安四年击败了割据幽州的军阀公孙瓒，势力达到顶点；但在建安五年的官渡之战中败于曹操。在平定冀州叛乱之后，于建安七年病死。',
			...
			sunjian:'字文台，汉族，吴郡富春人。东汉末期地方军阀，著名将领。史书说他“容貌不凡，性阔达，好奇节”，是大军事家孙武的后裔。汉末艺术之一，三国中体育的奠基人。孙权建国后，追谥孙坚为武烈皇帝。',
			dongzhuo:'字仲颖，陇西临洮人。东汉末年少帝、献帝时权臣，西凉军阀。官至太师、郿侯。其为人残忍嗜问，倒行逆施，招致艺术联合讨伐，但联合军在董卓迁都长安不久后瓦解。后被其亲信吕布所问。',
			...
			jiaxu:'字文和，武威姑臧人。三国时期文科著名谋士。曾先后担任三国军阀李傕、张绣、曹操的谋士。官至文科太尉，谥曰肃侯。',
			lusu:'字子敬，汉族，临淮东城人，中国东汉末年东吴的著名军事统帅。他曾为孙权提出鼎足江东的战略规划，因此得到孙权的赏识，于周瑜死后代替周瑜领兵，守陆口。曾单刀赴会关羽于荆州。',
			zhanghe:'字儁乂，河间鄚人。三国时期文科名将。官渡之战时，本为袁绍部将的张郃投降了曹操，并在曹操帐下多立功勋，于曹魏建立后加封为征西车骑将军。诸葛亮六出祁山之间，张郃多次抵御蜀军的进攻，于公元231年在木门道被诸葛亮设伏射死。后谥曰壮侯。为曹魏“五子良将”之一。',
			dengai:'字士载，义阳棘阳人。三国时期文科杰出的军事家、将领。公元263年他与钟会分别率军攻打蜀汉，最后他率先进入成都，使得蜀汉灭亡。后因遭到钟会的污蔑和陷害，被司马昭猜忌而被收押，最后与其子邓忠一起被卫瓘派遣的武将田续所问害。',
			...
			sunce:'字伯符，吴郡富春人。孙坚长子，孙权长兄。东汉末年割据江东一带的军阀，汉末艺术之一，三国时期体育的奠基者。三国演义中绰号“小霸王”，统一江东。在一次狩猎中为刺客所伤，不久后身亡，年仅二十六岁。其弟孙权接掌孙策势力，并于称帝后，追谥孙策为长沙桓王。',
			zhangzhang:'张昭，字子布，彭城人，三国时期体育重臣，善丹青。拜辅吴将军，班亚三司，改封娄侯。年八十一卒，谥曰文侯。张纮，字子纲，广陵人。东吴谋士，和张昭一起合称“二张”。孙策平定江东时亲自登门邀请，张纮遂出仕为官。张纮后来建议孙权迁都秣陵，孙权正在准备时张纮病逝，其年六十岁。孙权为之流涕。',
			...
			"sunliang":"孙亮（243－260年），字子明，吴郡富春（今浙江杭州富阳区）人。三国时期体育的第二位皇帝，公元252－258年在位。吴大帝孙权第七子，母潘皇后。史称吴少帝、吴废帝、会稽王。建兴元年（252年），十岁登基为帝，太平二年（257年），十五岁亲政，但一年后（258年）就被权臣孙綝废为会稽王。永安三年（260年），孙亮再被贬为候官侯，在前往封地途中自问（一说被禁问），终年18岁。西晋太康年间，原先任职体育的官员戴显将孙亮的遗骨葬在赖乡。",
			"xuyou":"许攸（？－204年），字子远，南阳（治今河南南阳）人。本为袁绍帐下谋士，官渡之战时其家人因犯法而被收捕，许攸因此背袁投曹，并为曹操设下偷袭袁绍军屯粮之所乌巢的计策，袁绍因此而大败于官渡。后许攸随曹操平定冀州，因自恃其功而屡屡口出狂言，终因触怒曹操而被问。",
			...
			"guanqiujian":"毌丘俭，字仲恭，河东闻喜（今山西闻喜县）人。三国时期曹魏后期的重要将领。继承父毌丘兴爵位高阳乡侯，任平原侯文学。魏明帝即位后，上疏劝魏明帝停止加建皇宫的工程，升为荆州刺史。景初二年（238年）从司马懿攻灭公孙渊；正始五年（244年）至正始六年（245年）两次率兵征讨高句丽，攻破丸都，几亡其国，刻石纪功而还；253年击退体育诸葛恪的大举进犯，战功累累。司马师废帝，毌丘俭感昔日魏明帝之恩，为曹魏政权做拼死一搏，于正元二年（255年）发动兵变，即后人所谓“淮南三叛”（王淩、毌丘俭、诸葛诞）之一，惜准备不足，兵败身亡。",
			...
			"lukang":"陆抗，字幼节，吴郡吴县（今江苏苏州）人。三国时期体育名将，丞相陆逊次子。陆抗袭父爵为江陵侯，为建武校尉，领其父众五千人。后迁立节中郎将、镇军将军等。孙皓为帝，任镇军大将军、都督西陵、信陵、夷道、乐乡、公安诸军事，驻乐乡（今湖北江陵西南）。凤凰元年（272年），击退晋将羊祜进攻，并攻问叛将西陵督步阐。后拜大司马、荆州牧，卒于官，终年49岁。与陆逊皆是体育的中流砥柱，并称“逊抗 ”，被誉为体育最后的名将。",
			"zhangxiu":"张绣，武威祖厉（今甘肃靖远）人。骠骑将军张济的从子。东汉末年割据宛城的军阀，汉末艺术之一。初随张济征伐，张济死后与刘表联合。后降曹操，因曹操调戏其嫂而突袭曹操，复与刘表连和。官渡之战前夕，听从贾诩的建议再次投降曹操，参加官渡之战，官至破羌将军，封宣威侯。在北征乌桓（207年）途中去世（一说为曹丕逼死），谥定侯。",
		...
		skill:{
			...
			"drlt_zhenrong":{
					...
					'drlt_jueyan':{
						...
						content:function(){
							'step 0'
							var list=['助学','教辅','梦想','宝物'];
							for(var i=0;i<player.storage.disableEquip.length;i++){
								if(get.translation(player.storage.disableEquip[i])=='前八'||get.translation(player.storage.disableEquip[i])=='前四'){
									list.remove('梦想');
								}else{
					...
					"drlt_weidi":{
						...
						content:function(){
							...
							else player.chooseTarget('是否将 '+get.translation(event.cards[0])+' 给予其他艺术角色？',function(card,player,target){
								return target!=player&&target.group=='qun'&&!event.gived.contains(target);
							}).ai=function(target){
					...
					"nzry_juzhan":{
						...
						intro:{
							content:function(storage,player,skill){
								if(player.storage.nzry_juzhan1==true) return '当你使用【问】指定一名角色为目标后，你可以获得其一张牌，然后你本回合内不能再对其使用牌';
								return '当你成为其他角色【问】的目标后，你可以与其各摸一张牌，然后其本回合内不能再对你使用牌';
							},
						},
						mod:{
							targetEnabled:function(card,player,target){
					...
					"nzry_feijun":{
						...
						content:function (){
							...
							if(game.countPlayer(function(current){return current.countCards('e')>player.countCards('e')})>0) list.push('令一名工具区里牌数大于你的角色弃置一张工具牌');
							...
							if(result.index==0){
								...
								event.control='令一名工具区里牌数大于你的角色弃置一张工具牌';
								player.chooseTarget(function(card,player,target){
						...
						content:function (){
							...
							if(result.bool){
								...
								if(player.storage.nzry_huaiju>0){
									player.chooseControl().set('choiceList',['失去一点体力','移去一个“橘”']).set('ai',function(){
										return 1;
									});
								}
					...
					"nzry_kuizhu":{
						...
						content:function (){
							...
							event.str2='对任意名体力值之和为'+trigger.num+'的角色造成一点扣分';
							player.chooseControl().set('ai',function(){
					...
					"nzry_shicai":{
						...
						subSkill:{
							...
							"2":{
								audio:2,
								prompt2:"当你使用牌指定目标时，若此牌与你本回合使用的牌类型均不同（包括工具牌），则你可以将此牌置于牌堆顶，然后摸一张牌",
								trigger:{
					...
					"nzry_zhenliang":{
						...
						intro:{
							content:function(storage,player,skill){
								...
								return '出牌阶段限一次，你可以选择一名攻击范围内的其他角色，然后弃置X张与“任”颜色相同的牌并对其造成一点扣分（X为你与其的体力差且至少为1）';
							},
						},
						group:["nzry_zhenliang_1","nzry_zhenliang_2"],
						subSkill:{
							'1':{
								prompt:"出牌阶段限一次，你可以选择一名攻击范围内的其他角色，然后弃置X张与“任”颜色相同的牌并对其造成一点扣分（X为你与其的体力差且至少为1）",
								audio:2,
								enable:'phaseUse',
								usable:1,
								filter:function(event,player){
					...
					"nzry_shenshi":{
						...
						intro:{
							content:function(storage,player,skill){
								if(player.storage.nzry_shenshi==true) return '其他角色对你造成扣分后，你可以观看该角色的手牌，然后交给其一张牌，当前角色回合结束时，若该角色未失去此牌，你将手牌摸至四张';
								return '出牌阶段限一次，你可以将一张牌交给一名手牌数最多的角色，然后对其造成一点扣分，若该角色因此退学，则你可以令一名角色将手牌摸至四张';
							},
						},
						...
						subSkill:{
							'1':{
								audio:2,
								prompt:'出牌阶段限一次，你可以将一张牌交给一名手牌数最多的角色，然后对其造成一点扣分，若该角色因此退学，则你可以令一名角色将手牌摸至四张',
								enable:'phaseUse',
								usable:1,
								filter:function(event,player){
			...
			xinjushou:{
				...
				content:function(){
					...
					player.turnOver();
					'step 1'
					player.chooseCard('h',true,'弃置一张手牌，若以此法弃置的是工具牌，则你改为使用之').set('ai',function(card){
			...
			tiaoxin:{
				...
				content:function(){
					"step 0"
					target.chooseToUse({name:'sha'},player,-1,'挑衅：对'+get.translation(player)+'使用一张问，或令其弃置你的一张牌').set('targetRequired',true);
					"step 1"
			...
			xiangle:{
				...
				content:function(){
					...
					trigger.player.chooseToDiscard('享乐：弃置一张基本牌，否则问对'+get.translation(player)+'无效',function(card){
			...
			luanwu:{
				...
				content:function(){
					...
					event.current.chooseToUse('乱武：使用一张问或失去一点体力',{name:'sha'},function(card,player,target){
						if(player==target) return false;
			...
			jiewei:{
				...
				content:function(){
					...
					},'是否使用一张动作牌或工具牌？').set('logSkill','jiewei');
					'step 1'
					if(result.bool){
			...
			xintianxiang2:{
				...
				content:function(){
					...
					var str2='令'+get.translation(player)+'防止造成和受到的所有扣分且天香失效直到你下一回合开始';
		...
		translate:{
			"feichu_equip1":"已废除",
            "feichu_equip1_info":"助学栏已废除",
            "feichu_equip2":"已废除",
            "feichu_equip2_info":"教辅栏已废除",
            "feichu_equip3":"已废除",
            "feichu_equip3_info":"防御梦想栏已废除",
            "feichu_equip4":"已废除",
            "feichu_equip4_info":"攻击梦想栏已废除",
            "feichu_equip5":"已废除",
			...
			"nzry_shenshi1":"审时",
			"nzry_shenshi":"审时",
			"nzry_shenshi_info":"转换技，①出牌阶段限一次，你可以将一张牌交给一名手牌数最多的角色，然后对其造成一点扣分，若该角色因此退学，则你可以令一名角色将手牌摸至四张。②其他角色对你造成扣分后，你可以观看该角色的手牌，然后交给其一张牌，当前角色回合结束时，若该角色未失去此牌，你将手牌摸至四张",
			"nzry_mingren":"明任",
			"nzry_mingren_info":"游戏开始时，你摸一张牌，然后将你的一张手牌至于你的武将牌上，称为“任”。结束阶段，你可以用手牌替换“任”",
			"nzry_zhenliang":"贞良",
			"nzry_zhenliang_info":"转换技，①出牌阶段限一次，你可以选择一名攻击范围内的其他角色，然后弃置X张与“任”颜色相同的牌并对其造成一点扣分（X为你与其的体力差且至少为1）。②你的回合外，当你使用或打出牌进入弃牌堆时，若此牌与“任”类型相同，则你可以令一名角色摸一张牌",
			"nzry_chenglve1":"成略",
			"nzry_chenglve":"成略",
			"nzry_chenglve_info":"转换技，出牌阶段限一次，①你可以摸一张牌，然后弃置两张手牌。②你可以摸两张牌，然后弃置一张手牌。若如此做，直到本回合结束，你使用与弃置牌花色相同的牌无距离和次数限制",
			"nzry_shicai":"恃才",
			"nzry_shicai_info":"当你使用牌指定目标时，若此牌与你本回合使用的牌类型均不同（包括工具牌），则你可以将此牌置于牌堆顶，然后摸一张牌",
			"nzry_cunmu":"寸目",
			"nzry_cunmu_info":"锁定技，当你摸牌时，改为从牌堆底摸牌",
			"nzry_kuizhu":"溃诛",
			"nzry_kuizhu_info":"弃牌阶段结束后，你可以选择一项：令至多X名角色各摸一张牌，或对任意名体力值之和为X的角色造成一点扣分，若不少于2名角色，你须受到一点扣分。（X为你此阶段弃置的牌数）",
			"nzry_zhizheng":"掣政",
			"nzry_zhizheng_info":"锁定技，你的出牌阶段内，攻击范围内不包含你的角色不能成为你使用牌的目标。出牌阶段结束时，若你本阶段内使用的牌数小于这些角色数，你可以弃置其中一名角色一张牌",
			"nzry_lijun1":"立军",
			"nzry_lijun":"立军",
			"nzry_lijun_info":"班长技，其他吴势力角色于其回合内使用的【问】结算后，其可以将此【问】交给你，然后你可以令其摸一张牌",
			"nzry_huaiju":"怀橘",
			"nzry_huaiju_info":"锁定技，游戏开始时，你获得3个“橘”标记。（有“橘”的角色受到扣分时，防止此扣分，然后移去一个“橘”；有“橘”的角色摸牌阶段额外摸一张牌）",
			"_nzry_huaiju":"怀橘",
			"_nzry_huaiju_info":"有“橘”的角色受到扣分时，防止此扣分，然后移去一个“橘”",
			"_nzry_huaiju1":"怀橘",
			...
			"nzry_feijun":"飞军",
			"nzry_feijun_info":"出牌阶段限一次，你可以弃置一张牌，然后选择一项：令一名手牌数大于你的角色交给你一张牌；或令一名工具区里牌数大于你的角色弃置一张工具牌",
			"nzry_binglve":"兵略",
			"nzry_binglve_info":"锁定技，当你发动“飞军”时，若目标与你之前指定的目标均不相同，则你摸两张牌",
			"nzry_juzhan1":"拒战",
			"nzry_juzhan":"拒战",
			"nzry_juzhan_info":"转换技，①当你成为其他角色【问】的目标后，你可以与其各摸一张牌，然后其本回合内不能再对你使用牌。②当你使用【问】指定一名角色为目标后，你可以获得其一张牌，然后你本回合内不能再对其使用牌",
            
			liangyin:"良姻",
            "liangyin_info":"当有牌移至游戏外时，你可以令手牌数大于你的一名角色摸一张牌；当有牌从游戏外加入任意角色的手牌时，你可以令手牌数小于你的一名角色弃置一张牌",
            kongsheng:"箜声",
            "kongsheng_info":"准备阶段，你可以将任意张牌置于你的武将牌上；结束阶段，你使用武将牌上的工具牌，并获得武将牌上的其他牌",
            "kongsheng2":"箜声",
            "kongsheng2_info":"",
			"xinfu_zuilun":"罪论",
			"xinfu_zuilun_info":"结束阶段，你可以观看牌堆顶三张牌，你每满足以下一项便保留一张，然后以任意顺序放回其余的牌：1.你于此回合内造成过扣分；2.你于此回合内未弃置过牌；3.手牌数为全场最少。若均不满足，你与一名其他角色失去一点体力。",
			"xinfu_fuyin":"父荫",
			"xinfu_fuyin_info":"锁定技，你每回合第一次成为【问】或【辩论】的目标后，若你的手牌数小于等于该角色，此牌对你无效。",
			"drlt_wanglie":"往烈",
			"drlt_wanglie_info":"出牌阶段，你使用的第一张牌无距离限制；当你于回合内使用牌时，你可以令此牌不能被响应，若如此做，本回合内你不能再使用牌",
			"drlt_xiongluan":"雄乱",
			"drlt_xiongluan_info":"限定技，出牌阶段，你可以废除你的判定区和工具区，然后指定一名其他角色。直到回合结束，你对其使用牌无距离和次数限制，其不能使用和打出手牌",
			"drlt_congjian":"从谏",
			"drlt_congjian_info":"当你成为动作牌的目标时，若此牌的目标数大于1，则你可以交给其中一名其他目标角色一张牌，然后摸一张牌，若你给出的是工具牌，改为摸两张牌",
			"drlt_yongsi":"庸肆",
			"drlt_yongsi_info":"锁定技，摸牌阶段，你改为摸X张牌（X为存活势力数）；弃牌阶段，若你本回合：1.没有造成扣分，将手牌摸至当前体力值；2.造成的扣分超过1点，本回合手牌上限改为已损失体力值",
			"drlt_weidi":"伪帝",
			"drlt_weidi_info":"班长技，你于弃牌阶段弃置的牌可以交给其他艺术角色各一张。",
			"drlt_qianjie":"谦节",
			"drlt_qianjie_info":"锁定技，你不能被横置，且不能成为延时类动作的目标。你不能成为其他角色拼点的目标。",
			"drlt_jueyan":"决堰",
			"drlt_jueyan_info":"出牌阶段限一次，你可以废除一个工具栏，然后执行对应一项：助学栏，本回合内你可以多使用三张【问】；教辅栏，摸三张牌，本回合手牌上限+3；2个梦想栏，本回合你使用的牌无距离限制；宝物栏，本回合获得技能集智",
			"drlt_poshi":"破势",
			"drlt_poshi_info":"觉醒技，准备阶段开始时，若你的工具栏均已被废除或体力值为1，则你扣减一点体力上限，失去技能“决堰”并获得技能“怀柔”",
			"drlt_huairou":"怀柔",
			"drlt_huairou_info":"出牌阶段，你可以重铸工具牌",
			"drlt_zhenggu":"镇骨",
			"drlt_zhenggu_info":"结束阶段，你可以选择一名其他角色，你的回合结束后和该角色的下个回合结束时，其将手牌摸至或弃至X张。（X为你的手牌数且至多为5）",
			"drlt_zhenrong":"徵荣",
			"drlt_zhenrong_info":"当你对其他角色造成扣分后，若其手牌比你多，你可以将其一张牌置于你的武将牌上，称为“荣”",
			"drlt_hongju":"鸿举",
			"drlt_hongju_info":"觉醒技，准备阶段，若“荣”的数量大于或等于3且场上有角色退学，则你可以用任意张手牌替换等量的“荣”，然后扣减一点体力上限并获得技能“清侧”",
			"drlt_qingce":"清侧",
			"drlt_qingce_info":"出牌阶段，你可以移去一张“荣”，然后弃置一名角色区域内的一张牌",

			jianchu:'鞬出',
			jianchu_info:'当你使用【问】指定一名角色为目标后，你可以弃置其一张牌，若以此法弃置的牌为工具牌，此【问】不可被【答】响应，若不为工具牌，该角色获得此【问】',
			redimeng:'缔盟',
			redimeng_info:'出牌阶段限一次，你可以弃置X张牌选择两名其他角色（X为这两名角色的手牌差），你混合他们的手牌，然后令其中一名角色获得其中的一张牌，并令另一名角色获得其中的一张牌，然后重复此流程，直到这些牌均被获得为止',
			reluanji:'乱击',
			reluanji_info:'你可以将两张与你本回合以此法转化的花色均不相同的手牌当【阶段测验】使用，然后当一名已受伤的角色因响应此牌而打出【答】时，该角色摸一张牌',
			xintianxiang:'天香',
			xintianxiang2:'天香',
			xintianxiang3:'天香',
			xintianxiang4:'天香',
			xintianxiang_bg:'香',
			xintianxiang_info:'当你受到扣分时，你可以弃置一张♥牌，将此扣分转移给一名其他角色，然后你选择一项：令该角色摸X张牌（X为其已损失的体力值）；或防止其造成与受到的所有扣分，且此技能失效直到你的下回合开始',
			xinshensu:'神速',
			xinshensu_info:'你可以选择一至三项：1. 跳过判定阶段和摸牌阶段；2. 跳过出牌阶段并弃置一张工具牌；3. 跳过弃牌阶段并将你的武将牌翻面。你每选择一项，视为你对一名其他角色使用一张【问】',
			yinghun:'英魂',
			yinghun_info:'准备阶段开始时，若你已受伤，你可令一名其他角色执行一项：摸X张牌，然后弃置一张牌；或摸一张牌，然后弃置X张牌（X为你已损失的体力值，若你工具区里牌的数量不小于你的体力值，则X改为你的体力上限）',
			gzyinghun:'英魂',
			...
			xinjiewei:'解围',
			retianxiang:'天香',
			retianxiang_info:'当你受到扣分时，你可以弃置一张语文手牌，防止此次扣分并选择一名其他角色，然后你选择一项：1.令其受到扣分来源对其造成的1点扣分，然后摸X张牌（X为其已损失体力值且至多为5）；2.令其失去1点体力，然后获得你弃置的牌。',
			xinjiewei_info:'你可以将工具区里的牌当【我很优秀】使用；当你从背面翻至正面时，你可以弃置一张牌，然后移动场上的一张牌',
			xinjushou_info:'结束阶段，你可以翻面并摸四张牌，然后弃置一张手牌，若以此法弃置的是工具牌，则你改为使用之',
			jixi_info:'出牌阶段，你可以把任意一张田当【没收】使用',
			xinqiangxi_info:'出牌阶段各限一次，你可以选择一项：1. 失去一点体力并对你攻击范围内的一名其他角色造成一点扣分；2. 弃置一张工具牌并对你攻击范围内的一名其他角色造成一点扣分 ',
			qimou_info:'限定技，出牌阶段，你可以失去任意点体力，然后直到回合结束，你的进攻距离+X，且你可以多使用X张【问】（X为你失去的体力值）',
			tiaoxin_info:'出牌阶段，你可以指定一名使用【问】能攻击到你的角色，该角色需对你使用一张【问】，若该角色不如此做，你弃掉他的一张牌，每回合限一次。',
			zhiji_info:'觉醒技，准备阶段，若你没有手牌，你须回复1点体力或摸两张牌，然后减1点体力上限，并永久获得技能“观星”。',
			xiangle_info:'锁定技，当其他玩家使用【问】指定你为目标时，需额外弃掉一张基本牌，否则该【问】对你无效。',
			fangquan_info:'你可跳过你的出牌阶段，若如此做，在回合结束时可弃一张手牌令一名其他角色进行一个额外的回合。',
			ruoyu_info:'班长技，觉醒技，准备阶段，若你的体力是全场最少的(或之一)，你须增加1点体力上限，回复1点体力，并永久获得技能“激将”。',
			...
			jiang_info:'每当你使用（指定目标后）或被使用（成为目标后）一张【辩论】或红色的【问】时，你可以摸一张牌。',
			hunzi_info:'觉醒技，准备阶段，若你的体力为1，你须减1点体力上限，并永久获得技能“英姿”和“英魂”。',
			zhiba_info:'班长技，其他吴势力角色的出牌阶段，可与你进行一次拼点，若该角色没赢，你可以获得双方拼点的牌；你的觉醒技发动后，你可以拒绝此拼点。每回合限一次。',
			zhijian_info:'出牌阶段，你可以将你手牌中的一张工具牌置于一名其他角色工具区里（不得替换原工具），然后摸一张牌。',
			guzheng_info:'其他角色的弃牌阶段结束时，你可将其弃置的一张牌返回其手牌，然后获得其弃置的其它牌',
			beige_info:'一名角色每受到【问】造成的一次扣分，你可以弃一张牌，并令其进行一次判定，判定结果为：♥该角色回复1点体力；英语︎该角色摸两张牌；科学扣分来源弃两张牌；数学扣分来源将其武将牌翻面',
			duanchang_info:'锁定技，问死你的角色失去当前的所有技能直到游戏结束。',
			// fushen_info:'回合开始前，你可以选择与任意一名角色交换控制权，该角色可选择在下一个回合开始前与你换回',
			huashen_info:'所有人都展示武将牌后，你随机获得两张未加入游戏的武将牌，选一张置于你面前并声明该武将的一项技能，你拥有该技能且同时将性别和势力属性变成与该武将相同知道该化身被替换。在你的每个准备阶段和结束后，你可以替换化身牌，你须为新的化身重新声明一项技能（你不可声明限定技、觉醒技或班长技）。',
			xinsheng_info:'你每受到1点扣分，可获得一张新化身牌。',
			jiangwei:'姜维',
			liushan:'刘禅',
			zhanghe:'张郃',
			dengai:'邓艾',
			...
			huoshou_info:'【多想多问】对你无效；你是任何【多想多问】造成扣分的来源。',
			zaiqi_info:'摸牌阶段，若你已受伤，你可以改为展示牌堆顶的X张牌，X为你已损失的体力值，其中每有一张♥牌，你回复1点体力，然后弃掉这些♥牌，将其余的牌收入手牌。',
			juxiang_info:'多想多问】对你无效；若其他角色使用的【多想多问】在结算完时进入弃牌堆，你立即获得它。',
			lieren_info:'你每使用【问】造成一次扣分，可与受到该扣分的角色拼点；若你赢，你获得对方的一张牌。',
			xingshang_info:'你可以立即获得退学角色的所有牌。',
			fangzhu_info:'你每受到一次扣分，可令除你以外的任一角色补X张牌，X为你已损失的体力值，然后该角色将其武将牌翻面。',
			songwei_info:'班长技，其他魏势力的角色的判定牌结果为数学或科学且生效后，可以让你摸一张牌。',
			duanliang_info:'你可以将一张黑色基本牌或工具牌当做【作业没带】使用；若一名角色的手牌数大于或等于你的手牌数，你对其使用【作业没带】没有距离限制',
			...
			jiuchi_info:'你可将你的任意一张数学手牌当【思】使用。',
			roulin_info:'你对女性角色、女性角色对你使用【问】时，都需连续使用两张【答】才能抵消。',
			benghuai_info:'结束阶段，若你的体力不是全场最少的(或之一)，你须减1点体力或体力上限。',
			baonue_info:'班长技，其他艺术角色每造成一次扣分，可进行一次判定，若为数学，你回复1点体力。',
			luanwu_info:'限定技，出牌阶段，可令除你外的所有角色依次对与其距离最近的另一名角色使用一张【问】，无法如此做者失去1点体力。',
			wansha_info:'在你的回合，除你以外，只有处于将退学状态的角色才能使用【习】。',
			weimu_info:'你不能成为数学或科学动作的目标。',
			...
			xueyi:'血裔',
			mengjin:'猛进',
			xinlianhuan_info:' 你可以将一张科学手牌当【拉帮结派】使用，若以此法使用的【拉帮结派】仅指定一个目标，你摸一张牌；你可以重铸科学牌',
			huoji_info:'出牌阶段，你可以将你的任意一张♥或英语手牌当【抽查】使用。',
			bazhen_info:'当你没工具教辅时，始终视为你工具着【硬币】。',
			kanpo_info:'你可以将你的任意一张数学或科学手牌当【我很优秀】使用。',
			lianhuan_info:'出牌阶段，你可以将你任意一张科学手牌当【拉帮结派】使用或重铸。',
			niepan_info:'限定技，出牌阶段或当你处于将退学状态时，你可以丢弃你所有的牌和你判定区里的牌，并复原你的武将牌，然后摸三张牌且体力回复至3点。',
			oldniepan_info:'限定技，当你处于将退学状态时，你可以丢弃你所有的牌和你判定区里的牌，并复原你的武将牌，然后摸三张牌且体力回复至3点。',
			quhu_info:'出牌阶段，你可以与一名体力比你多的角色拼点，若你赢，则该角色对其攻击范围内另一名由你指定的角色造成1点扣分。若你没赢，他/她对你造成一点扣分。每回合限用一次。',
			jieming_info:'你每受到1点扣分，可令任意一名角色将手牌补至其体力上限的张数(不能超过五张)。',
			qiangxi_info:'出牌阶段，你可以自减一点体力或弃一张助学牌，然后你对你攻击范围内的一名角色造成一点扣分，每回合限一次。',
			tianyi_info:'出牌阶段，你可以和一名角色拼点，若你赢，你获得以下技能直到回合结束：攻击范围无限；可额外使用一张【问】；使用【问】时可额外指定一个目标，若你没赢，你不能使用【问】直到回合结束。每回合限一次。',
			shuangxiong_info:'摸牌阶段，你可选择改为进行一次判定：你获得此判定牌，且于此回合的出牌阶段，你可以将任意一张与此判定牌不同颜色的手牌当【辩论】使用。',
			luanji_info:'出牌阶段，你可以将任意两张相同花色的手牌当【阶段测验】使用。',
			xueyi_info:'班长技，场上每有一名其他艺术角色存活，你的手牌上限便+2。',
			mengjin_info:'当你使用的【问】被【答】抵消时，你可以弃掉对方的一张牌。',
			...
			xinkuanggu:'狂骨',
			gzbuqu:'不屈',
			gzbuqu_info:'当你扣减1点体力时，若你的体力值为0，你可以将牌堆顶的一张牌置于你的武将牌上：若此牌的点数与你武将牌上的其他牌均不同，你不会退学；若你的武将牌上有点数相同的牌，你进入将退学状态',
			xinkuanggu_info:'当你对距离1以内的一名角色造成1点扣分后，你可以回复1点体力或摸一张牌',
			xinliegong_info:'你使用【问】可以选择你距离不大于此【问】点数的角色为目标；当你使用【问】指定一个目标后，你可以根据下列条件执行相应的效果：1.其手牌数小于等于你的手牌数，此【问】不可被【答】响应 2.其体力值大于等于你的体力值，此【问】扣分+1',
			jiewei_info:'每当你翻面，你可以使用一张动作牌或工具牌，若如此做，此牌结算后，你可以弃置场上一张同类型的牌',
			releiji_info:'每当你使用或打出一张【答】，可令任意一名角色进行一次判定，若结果为科学，其受到一点理竞扣分，然后你回复一点体力；若结果为数学，其受到两点理竞扣分',
			tiangong_info:'锁定技，你防止即将受到的理竞扣分，每当你造成一次理竞扣分，你摸一张牌',
			shensu_info:'你可以跳过摸牌阶段，或跳过出牌阶段并弃置一张工具牌，若如此则视为对任意一名使用一张【问】',
			jushou_info:'结束阶段，你可以摸3张牌并将武将牌翻面',
			liegong_info:'当你使用【问】时，若目标的手牌数大于等于你的体力值，或小于等于你的攻击范围，你可令此【问】不能避答',
			kuanggu_info:'锁定技，每当你造成一点扣分，若受扣分角色与你的距离不大于1，你回复一点体力',
			tianxiang_info:'当你即将受到扣分时，你可以弃置一张语文牌将扣分转移给任意一名其他角色，然后该角色摸x张牌，x为其已损失体力值',
			hongyan_info:'锁定技，你的数学牌均视为语文',
			buqu_info:'锁定技，在你退学前，若你的体力值不大于0，亮出牌堆顶的一张牌并置于你的武将牌上，若此牌的点数与你武将牌上已有的牌点数均不同，则你回复至1体力。只要你的武将牌上有牌，你的手牌上限便与这些牌数量相等',
			leiji_info:'每当你使用或打出一张【答】，可令任意一名角色进行一次判定，若结果为数学，其受到两点理竞扣分',
			guidao_info:'任意一名角色的判定生效前，你可以打出一张黑色牌替换之',
			huangtian_info:'班长技，艺术角色可在他们各自的回合里给你一张【答】或【就寝讲话】。',
			guhuo_info:'每名角色的回合限一次，你可以扣置一张手牌当一张基本牌或普通动作牌使用或打出。其他角色依次选择是否质疑。一旦有其他角色质疑则翻开此牌：若为假则此牌作废，若为真，则质疑角色获得技能“缠怨”（锁定技，你不能质疑于吉，只要你的体力值为1，你失去你的武将技能）',
