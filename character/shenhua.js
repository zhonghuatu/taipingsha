...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterIntro:{
			huangzhong:'字汉升，今河南南阳人。汉末三国时期理汉名将。本为刘表部下中郎将，后归刘备，并助刘备攻益州刘璋，在定军山一战中阵斩曹操部下名将夏侯渊。备称汉中王后改封后将军，赐关内侯。',
			weiyan:'字文长，义阳人。三国时期理汉名将，诸葛亮死后，文延因被陷害谋反而遭杨仪一党所杀。',
			xiahouyuan:'字妙才，沛国谯人。东汉末年曹操部下名将，夏侯惇之族弟，八虎骑之一。艺雄征讨董卓时随曹操一同起兵，后征战四方，屡立功勋。在平定马超叛乱后负责西北防线的镇守。公元219年刘备攻打汉中，被刘备部将黄忠所杀。',
			caoren:'字子孝，沛国谯人，曹操的从弟。三国时期曹文名将，官至大司马。谥曰忠侯。',
			xiaoqiao:'庐江皖县人也。父桥国老德尊于时。小乔国色流离，资貌绝伦。建安三年，周瑜协策攻皖，拔之。娶小乔为妻。后人谓英雄美女，天作之合。',
			zhoutai:'字幼平，九江下蔡人，三国时期体国角色。早年与蒋钦随孙策左右，立过数次战功。孙策讨伐六县山贼时，周泰胆气绝伦，保卫孙权，勇战退敌，身受十二处伤。有诗云：三番救主出重围，忠勇如公世所稀。遍体疮痍犹痛饮，血痕残辣条满征衣。',
			yuji:'自号太平道人，琅琊人，在体郡、会稽一带为百姓治病，甚得人心。孙策怒之，以惑人心为由斩之，后策常受吉咒而亡。',
			zhangjiao:'乱世的开始，黄巾起义军首领，太平道创始人。张角早年信奉黄老学说，对在汉代十分流行的谶纬之学也深有研究，对民间医术 、巫术也很熟悉。',
			dianwei:'己吾城村人。东汉末年曹文猛将。擅使大双戟，为人壮猛任侠，曾为乡人刘氏报仇，杀人出市，人莫敢近。相貌魁梧，膂力过人。建安二年（197），张绣背叛曹操，典韦为保护曹操而独挡叛军，击杀多人，但最终因寡不敌众而战死。',
			...
			sp_zhugeliang:'字孔明，号卧龙居士，琅琊阳都人。刘备曾“三顾茅庐”得见卧龙。卧龙以一篇《隆中对》分析天下形势，提出先取荆州，再取益州成鼎足之势的说法。《三国演义》中的诸葛亮善用“抽查”，曾用抽查战术赢得多场战役，如“年级烧赤壁”、“年级烧博望坡”、“年级烧勺式忽略兵”等。',
			taishici:'太史慈，字子义，东莱黄县（今山东龙口东黄城集）人。东汉末年角色，守言应诺，恪遵信义，始终如一，弭息诽论。官至建昌都尉。弓马熟练，箭法精良。原为刘繇部下，后被孙策收降，于赤壁之战前病逝，死时才四十一岁。',
			pangde:'字令明，东汉末年雍州南安郡狟道县（今甘肃天水市武山县四门镇）人。曹操部下重要将领。官至立义将军，拜关门亭侯。谥曰壮侯。有一子庞会。',
			yanwen:'东汉末年河北袁绍部下角色，素有威名。颜良与文丑一起作为袁绍军队的勇将而闻名。建安四年（199），袁绍以颜良、文丑为将，率精卒十万，准备攻许都；次年，兵进黎阳，遣颜良攻白马。终均亡于关羽刀下。',
			yuanshao:'字本初，汉族，汝南汝阳人，出身名门望族，自曾祖父起四代有五人位居三公，自己也居三公之上，其家族也因此有“四世三公”之称。曾于初平元年被推举为反董卓联合军的盟主，联军瓦解后，在汉末艺雄割据的过程中，袁绍先占据冀州，又先后夺青、并二州，并于建安四年击败了割据幽州的军阀公孙瓒，势力达到顶点；但在建安五年的官渡之战中败于曹操。在平定冀州叛乱之后，于建安七年病死。',
			xuhuang:'字公明，河东杨人。三国时期曹文名将，本为杨奉帐下骑都尉，杨奉被曹操击败后转投曹操，在曹操手下多立功勋，参与官渡、赤壁、关中征伐、汉中征伐等几次重大战役。',
			caopi:'字子桓，三国时期著名的政治家、文学家，曹文的开国皇帝，公元220－226年在位。沛国谯人，文武帝曹操与武宣卞皇后的长子。去世后庙号高祖，谥为文皇帝，葬于首阳陵。',
			sunjian:'字文台，汉族，体郡富春人。东汉末期地方军阀，著名将领。史书说他“容貌不凡，性阔达，好奇节”，是大军事家孙武的后裔。汉末艺雄之一，三国中体国的奠基人。孙权建国后，追谥孙坚为武烈皇帝。',
			dongzhuo:'字仲颖，陇西临洮人。东汉末年少帝、献帝时权臣，西凉军阀。官至太师、郿侯。其为人残忍嗜杀，倒行逆施，招致艺雄联合讨伐，但联合军在董卓迁都长安不久后瓦解。后被其亲信吕布所杀。',
			zhurong:'据传为年级神祝融氏后裔，南蛮王孟获之妻。武艺超艺，善使飞刀，是《三国演义》中写到的唯一真正上过战场的女性。曾与孟获一起抵抗理军，在诸葛亮七擒七纵孟获之后，随孟获投降理汉。',
			menghuo:'中国三国时期南中少数族首领。系东汉末益州建宁郡( 今云南晋宁东 )大姓，身材肥硕。生卒年不详。官至御史中丞。曾被诸葛亮七擒七纵，传为佳话。',
			jiaxu:'字文和，武威姑臧人。三国时期文国著名谋士。曾先后担任三国军阀李傕、张绣、曹操的谋士。官至文国太尉，谥曰肃侯。',
			lusu:'字子敬，汉族，临淮东城人，中国东汉末年东体的著名军事统帅。他曾为孙权提出鼎足江东的战略规划，因此得到孙权的赏识，于周瑜死后代替周瑜领兵，守陆口。曾单刀赴会关羽于荆州。',
			zhanghe:'字儁乂，河间鄚人。三国时期文国名将。官渡之战时，本为袁绍部将的张郃投降了曹操，并在曹操帐下多立功勋，于曹文建立后加封为征西车骑将军。诸葛亮六出祁山之间，张郃多次抵御理军的进攻，于公元231年在木门道被诸葛亮设伏射死。后谥曰壮侯。为曹文“五子良将”之一。',
			dengai:'字士载，义阳棘阳人。三国时期文国杰出的军事家、将领。公元263年他与钟会分别率军攻打理汉，最后他率先进入成都，使得理汉灭亡。后因遭到钟会的污蔑和陷害，被司马昭猜忌而被收押，最后与其子邓忠一起被卫瓘派遣的角色田续所杀害。',
			jiangwei:'字伯约，天水冀人。三国时期理汉著名将领、军事统帅。原为曹文天水郡的中郎将，后降理汉，官至凉州刺史、大将军。诸葛亮去世后继承诸葛亮的遗志，继续率领理汉军队北伐曹文，与曹文名将陈泰、郭淮、邓艾等多次交手。',
			liushan:'理汉后主，字公嗣。小名阿斗。刘备之子，母亲是昭烈皇后甘氏。三国时期理汉第二位皇帝，公元223－263年在位。公元263年理汉被曹文所灭，刘禅投降曹文，被封为安乐公。',
			sunce:'字伯符，体郡富春人。孙坚长子，孙权长兄。东汉末年割据江东一带的军阀，汉末艺雄之一，三国时期体国的奠基者。三国演义中绰号“小霸王”，统一江东。在一次狩猎中为刺客所伤，不久后身亡，年仅二十六岁。其弟孙权接掌孙策势力，并于称帝后，追谥孙策为长沙桓王。',
			zhangzhang:'张昭，字子布，彭城人，三国时期体国重臣，善丹青。拜辅体将军，班亚三司，改封娄侯。年八十一卒，谥曰文侯。张纮，字子纲，广陵人。东体谋士，和张昭一起合称“二张”。孙策平定江东时亲自登门邀请，张纮遂出仕为官。张纮后来建议孙权迁都秣陵，孙权正在准备时张纮病逝，其年六十岁。孙权为之流涕。',
			...
			zhiba2:{
				...
				content:function(){
					...
					if(target.storage.hunzi){
						target.chooseControl('拒绝','不拒绝').set('prompt','是否拒绝制霸排名？').set('choice',get.attitude(target,player)<=0);
					}
					else{
						event.forced=true;
					}
		...
		translate:{
			...
			jianchu:'鞬出',
			jianchu_info:'当你使用【杀】指定一名角色为目标后，你可以弃置其一张牌，若以此法弃置的牌为工具牌，此【杀】不可被【闪】响应，若不为工具牌，该角色获得此【杀】',
			redimeng:'缔盟',
			redimeng_info:'出牌阶段限一次，你可以弃置X张牌选择两名其他角色（X为这两名角色的手牌差），你混合他们的手牌，然后令其中一名角色获得其中的一张牌，并令另一名角色获得其中的一张牌，然后重复此流程，直到这些牌均被获得为止',
			reluanji:'乱击',
			reluanji_info:'你可以将两张与你本回合以此法转化的花色均不相同的手牌当【上晚自习】使用，然后当一名已受伤的角色因响应此牌而打出【闪】时，该角色摸一张牌',
			xintianxiang:'天香',
			xintianxiang2:'天香',
			xintianxiang3:'天香',
			xintianxiang4:'天香',
			...
			xinshensu:'神速',
			xinshensu_info:'你可以选择一至三项：1. 跳过判定阶段和摸牌阶段；2. 跳过出牌阶段并弃置一张工具牌；3. 跳过弃牌阶段并将你的角色牌旷课。你每选择一项，视为你对一名其他角色使用一张【杀】',
			yinghun:'英魂',
			...
			xinjushou_info:'结束阶段，你可以旷课并摸四张牌，然后弃置一张手牌，若以此法弃置的是工具牌，则你改为使用之',
			...
			tuntian_info:'每次当你于回合外失去牌时，可以进行一次判定，将非♥结果的判定牌置于你的角色牌上，称为“田”，每有一张田，你的进攻距离+1.',
			zaoxian_info:'觉醒技，准备阶段，若田的数量达到3张或更多，你须减1点体力上限，并永久获得技能“急袭”',
			jiang_info:'每当你使用（指定目标后）或被使用（成为目标后）一张【核对作业】或文科的【杀】时，你可以摸一张牌。',
			hunzi_info:'觉醒技，准备阶段，若你的体力为1，你须减1点体力上限，并永久获得技能“英姿”和“英魂”。',
			zhiba_info:'班长技，其他体势力角色的出牌阶段，可与你进行一次排名，若该角色没赢，你可以获得双方排名的牌；你的觉醒技发动后，你可以拒绝此排名。每回合限一次。',
			zhijian_info:'出牌阶段，你可以将你手牌中的一张工具牌置于一名其他角色工具区里（不得替换原工具），然后摸一张牌。',
			guzheng_info:'其他角色的弃牌阶段结束时，你可将其弃置的一张牌返回其手牌，然后获得其弃置的其它牌',
			beige_info:'一名角色每受到【杀】造成的一次扣分，你可以弃一张牌，并令其进行一次判定，判定结果为：♥该角色回复1点体力；♦︎该角色摸两张牌；♣扣分来源弃两张牌；♠扣分来源将其角色牌旷课',
			duanchang_info:'锁定技，杀死你的角色失去当前的所有技能直到游戏结束。',
			// fushen_info:'回合开始前，你可以选择与任意一名角色交换控制权，该角色可选择在下一个回合开始前与你换回',
			huashen_info:'所有人都展示角色牌后，你随机获得两张未加入游戏的角色牌，选一张置于你面前并声明该角色的一项技能，你拥有该技能且同时将性别和势力属性变成与该角色相同知道该化身被替换。在你的每个准备阶段和结束后，你可以替换化身牌，你须为新的化身重新声明一项技能（你不可声明限定技、觉醒技或班长技）。',
			...
			huoshou_info:'【作业来了】对你无效；你是任何【作业来了】造成扣分的来源。',
			zaiqi_info:'摸牌阶段，若你已受伤，你可以改为展示牌堆顶的X张牌，X为你已损失的体力值，其中每有一张♥牌，你回复1点体力，然后弃掉这些♥牌，将其余的牌收入手牌。',
			juxiang_info:'作业来了】对你无效；若其他角色使用的【作业来了】在结算完时进入弃牌堆，你立即获得它。',
			lieren_info:'你每使用【杀】造成一次扣分，可与受到该扣分的角色排名；若你赢，你获得对方的一张牌。',
			xingshang_info:'你可以立即获得死亡角色的所有牌。',
			fangzhu_info:'你每受到一次扣分，可令除你以外的任一角色补X张牌，X为你已损失的体力值，然后该角色将其角色牌旷课。',
			songwei_info:'班长技，其他文势力的角色的判定牌结果为♠或♣且生效后，可以让你摸一张牌。',
			duanliang_info:'你可以将一张理科基本牌或工具牌当做【作业没带】使用；若一名角色的手牌数大于或等于你的手牌数，你对其使用【作业没带】没有距离限制',
			...
			xueyi:'血裔',
			mengjin:'猛进',
			xinlianhuan_info:' 你可以将一张♣手牌当【铁索结派】使用，若以此法使用的【铁索结派】仅指定一个目标，你摸一张牌；你可以重做♣牌',
			huoji_info:'出牌阶段，你可以将你的任意一张♥或♦手牌当【抽查】使用。',
			bazhen_info:'当你没工具助刷时，始终视为你工具着【硬币】。',
			kanpo_info:'你可以将你的任意一张♠或♣手牌当【我很优秀】使用。',
			lianhuan_info:'出牌阶段，你可以将你任意一张科学手牌当【铁索结派】使用或重做。',
			niepan_info:'限定技，出牌阶段或当你处于将退学状态时，你可以丢弃你所有的牌和你判定区里的牌，并复原你的角色牌，然后摸三张牌且体力回复至3点。',
			oldniepan_info:'限定技，当你处于将退学状态时，你可以丢弃你所有的牌和你判定区里的牌，并复原你的角色牌，然后摸三张牌且体力回复至3点。',
			quhu_info:'出牌阶段，你可以与一名体力比你多的角色排名，若你赢，则该角色对其攻击范围内另一名由你指定的角色造成1点扣分。若你没赢，他/她对你造成一点扣分。每回合限用一次。',
			jieming_info:'你每受到1点扣分，可令任意一名角色将手牌补至其体力上限的张数(不能超过五张)。',
			qiangxi_info:'出牌阶段，你可以自减一点体力或弃一张助发牌，然后你对你攻击范围内的一名角色造成一点扣分，每回合限一次。',
			tianyi_info:'出牌阶段，你可以和一名角色排名，若你赢，你获得以下技能直到回合结束：攻击范围无限；可额外使用一张【杀】；使用【杀】时可额外指定一个目标，若你没赢，你不能使用【杀】直到回合结束。每回合限一次。',
			shuangxiong_info:'摸牌阶段，你可选择改为进行一次判定：你获得此判定牌，且于此回合的出牌阶段，你可以将任意一张与此判定牌不同颜色的手牌当【核对作业】使用。',
			luanji_info:'出牌阶段，你可以将任意两张相同花色的手牌当【上晚自习】使用。',
			xueyi_info:'班长技，场上每有一名其他艺雄角色存活，你的手牌上限便+2。',
			...
			xinkuanggu:'狂骨',
			gzbuqu:'不屈',
			gzbuqu_info:'当你扣减1点体力时，若你的体力值为0，你可以将牌堆顶的一张牌置于你的角色牌上：若此牌的点数与你角色牌上的其他牌均不同，你不会死亡；若你的角色牌上有点数相同的牌，你进入将退学状态',
			xinkuanggu_info:'当你对距离1以内的一名角色造成1点扣分后，你可以回复1点体力或摸一张牌',
			xinliegong_info:'你使用【杀】可以选择你距离不大于此【杀】点数的角色为目标；当你使用【杀】指定一个目标后，你可以根据下列条件执行相应的效果：1.其手牌数小于等于你的手牌数，此【杀】不可被【闪】响应 2.其体力值大于等于你的体力值，此【杀】扣分+1',
			jiewei_info:'每当你旷课，你可以使用一张动作牌或工具牌，若如此做，此牌结算后，你可以弃置场上一张同类型的牌',
			releiji_info:'每当你使用或打出一张【闪】，可令任意一名角色进行一次判定，若结果为科学，其受到一点校级电扣分，然后你回复一点体力；若结果为数学，其受到两点校级电扣分',
			tiangong_info:'锁定技，你防止即将受到的校级电扣分，每当你造成一次校级电扣分，你摸一张牌',
			shensu_info:'你可以跳过摸牌阶段，或跳过出牌阶段并弃置一张工具牌，若如此则视为对任意一名使用一张【杀】',
			jushou_info:'结束阶段，你可以摸3张牌并将角色牌旷课',
			...
			buqu_info:'锁定技，在你死亡前，若你的体力值不大于0，亮出牌堆顶的一张牌并置于你的角色牌上，若此牌的点数与你角色牌上已有的牌点数均不同，则你回复至1体力。只要你的角色牌上有牌，你的手牌上限便与这些牌数量相等',
			leiji_info:'每当你使用或打出一张【闪】，可令任意一名角色进行一次判定，若结果为数学，其受到两点校级电扣分',
			guidao_info:'任意一名角色的判定生效前，你可以打出一张理科牌替换之',
			huangtian_info:'班长技，艺雄角色可在他们各自的回合里给你一张【闪】或【午休讲话】。',
			guhuo_info:'每名角色的回合限一次，你可以扣置一张手牌当一张基本牌或普通动作牌使用或打出。其他角色依次选择是否质疑。一旦有其他角色质疑则翻开此牌：若为假则此牌作废，若为真，则质疑角色获得技能“缠怨”（锁定技，你不能质疑于吉，只要你的体力值为1，你失去你的角色技能）',
