...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			xinjizhi_info_alter:'每当你使用一张非转化的动作牌，可以摸一张牌，如果摸到的是基本牌，你可以弃置这张牌，然后本回合手牌上限+1',
			xinqicai:'奇才',
			xinqicai_info:'锁定技，你使用的动作牌无距离限制',
			xinqicai_info_alter:'锁定技，你使用的动作牌无距离限制，你工具区内的牌不能被弃置',
			qicai_info:'锁定技，你使用的动作牌无距离限制',
