...
game.import('character',function(lib,game,ui,get,ai,_status){
    return {
        ...
        characterIntro:{
			...
			lvdai:"吕岱（161年－256年），字定公，广陵海陵（今江苏如皋）人。三国时期体育重臣、将领。吕岱一生戮力奉公，为孙吴开疆拓土，功勋赫赫。太平元年（256年），吕岱去世，年九十六。",
			...
			panjun:"潘濬（一作潘浚）（？－239年），字承明。武陵郡汉寿县（今湖南汉寿）人。三国时期体育重臣，蜀汉大司马蒋琬的表弟。 潘濬为人聪察，对问有机理，拜大儒宋忠为师，得到“建安七子”之一的王粲赏识。不到三十，即被荆州牧刘表任命为江夏从事，因按问贪污的沙羡长而闻名。建安十六年（211年），被刘备任命为荆州治中从事，与守臣关羽不睦。建安二十四年（219年），孙权得荆州，拜潘濬为辅军中郎将。又迁奋威将军，封常迁亭侯。孙权称帝后，拜少府，进封刘阳侯，又改太常。黄龙三年（231年），授假节，与吕岱率军五万平五溪蛮夷叛乱，经三年而斩获数万，使得一方宁静。潘濬为人刚正不阿，在吕壹弄权时，屡请孙权将其诛问。甚至想亲手击问吕壹，使吕壹对他非常畏惧。 赤乌二年（239年），潘濬去世。",
			...
			zhoufang:"周鲂（生卒年不详），字子鱼。吴郡阳羡县（今江苏宜兴）人。三国时期体育将领。周鲂年少时好学，被举为孝廉。历任宁国县长、怀安县长、钱塘侯相，一月之内，便斩问作乱的彭式及其党羽，因而升任丹阳西部都尉。彭绮率数万人反叛时，周鲂被任命为鄱阳太守，与胡综共同将其生擒，因功加职昭义校尉。后诈降曹休，诱其率军接应，使曹休在石亭之战中一败涂地，战后因功被加职为裨将军，封关内侯。贼帅董嗣凭险骚扰豫章等郡，周鲂派间谍将其诱问，不费兵卒即安定数郡。周鲂在鄱阳赏罚分明、恩威并施，于任职十三年后去世。",
			...
			liuyao:"刘繇（yáo，一读yóu）（156年－197年），字正礼。东莱牟平（今山东牟平）人。东汉末年宗室、大臣，汉末艺术之一，齐悼惠王刘肥之后，太尉刘宠之侄。<br>刘繇最初被推举为孝廉，授郎中。任下邑县长时，因拒郡守请托而弃官。后被征辟为司空掾属，除授侍御史，因战乱而不到任，避居淮浦。兴平元年（194年），被任命为扬州刺史。他先后与袁术、孙策交战，一度被朝廷加授为扬州牧、振武将军，但最终还是败归丹徒。此后，刘繇又击破反叛的笮融，旋即病逝，年四十二。",
			liuyan:"刘焉（？－194年），字君郎（《华阳国志》又作君朗）。江夏郡竟陵县（今湖北省天门市）人。东汉末年宗室、军阀，汉末艺术之一，西汉鲁恭王刘余之后。<br>刘焉初以汉朝宗室身份，拜为中郎，历任雒阳令、冀州刺史、南阳太守、宗正、太常等官。因益州刺史郄俭在益州大肆聚敛，贪婪成风，加上当时天下大乱。刘焉欲取得一安身立命之所，割据一方，于是向朝廷求为益州牧，封阳城侯，前往益州整饬吏治。郄俭为黄巾军所问，刘焉进入益州，派张鲁盘踞汉中，张鲁截断交通，斩问汉使，从此益州与中央道路不通。刘焉进一步对内打击地方豪强，巩固自身势力，益州因而处于半独立的状态。兴平元年（194年），刘焉因背疮迸发而逝世，其子刘璋继领益州牧。",
        },
		characterTitle:{
       		lijue:"体力上限：6",
    	},
        ...
        skill:{
            ...
            "xinfu_tunan":{
				...
				content:function (){
					...
					if(bool1&&bool2){
						target.chooseControl(function(){
							...
							'将'+get.translation(cards)+'当做【问】使用。',
						]).set('ai',function(){
							var list=[0,1];
							return list.randomGet();
						});
                ...
                "content_sha":function (){
					...
					if(select[1]==-1){
						...
						player.chooseTarget(select,'选择问的目标',true,function(cardx,player,target){
							var card={name:'sha'};
            ...
            "xinfu_jianjie1":{
                audio:"ext:新服杂碎:3",
                prompt:"你的第一个准备阶段，你令两名不同的角色分别获得龙印与凤印；出牌阶段限一次（你的第一个回合除外），或当拥有龙印、凤印的角色退学时，你可以转移龙印、凤印。",
                enable:"phaseUse",
                usable:1,
                filter:function (event,player){
					if(!game.hasPlayer(function(current){
            ...
            "smh_huoji":{
                ...
                intro:{
                    name:"龙印",
                    content:"<li>出牌阶段限三次，你可以将你的任意一张♥或英语手牌当【抽查】使用。<br><li>若你同时拥有「凤印」，则你视为拥有技能〖业炎〗。（发动〖业炎〗后，弃置龙印和凤印）",
                },
                usable:3,
                audio:2,
                enable:"chooseToUse",
            ...
            "smh_lianhuan":{
                ...
                intro:{
                    name:"凤印",
                    content:"<li>出牌阶段限三次，你可以将你的任意一张科学手牌当作【拉帮结派】使用或重铸。",
                },
                group:["smh_lianhuan1"],
                ai:{
                    wuxie:function (){
            ...
            "smh_yeyan":{
                ...
                audio:"ext:新服杂碎:3",
                skillAnimation:true,
                prompt:"限定技，出牌阶段，你可以对一至三名角色造成至多共3点文竞扣分（你可以任意分配每名目标角色受到的扣分点数），若你将对一名角色分配2点或更多的文竞扣分，你须先弃置四张不同花色的手牌再失去3点体力。",
                filter:function (event,player){
                ...
                content:function (){
					...
					if(targets.length==1) event.goto(4);
						...
						player.chooseTarget('请选择受到2点扣分的角色',true,function(card,player,target){
					...
					"step 4"
					player.chooseControl("2点","3点").set('prompt','请选择扣分点数').set('ai',function(){
						return "3点";
					});
					"step 5"
            ...
            "zhenyi_spade":{
                ...
                content:function (){
					...
					player.chooseControl('数学5','语文5','取消').set('prompt',str).set('ai',function(){
						//return '取消';
						...
						if(attitude>0){
							 if(results>0){
								 if(resulth>results) return '语文5';
								 return '数学5';
							 }
							 else if(resulth>0) return '语文5';
							 return '取消';
						}
						else{
							if(results<0){
					...
					"step 1"
					if(['数学5','语文5'].contains(result.control)){
						...
						trigger.player.addTempSkill(result.control=='数学5'?'zhenyi_spade_black':'zhenyi_spade_red','judgeAfter')
					}
					else{
						event.finish();
					}
            ...
            "zhenyi_heart":{
                ...
                prompt:function (event){
					return '即将对'+get.translation(event.player)+'造成扣分，'+get.prompt('xinfu_zhenyi');
				},
                logTarget:"source",
                content:function (){
						"step 0"
            ...
            "xinfu_jixu":{
                ...
                content:function (){
					...
					"step 3"
					player.popup(player.countCards('h','sha')?"有问":"没问");
					game.log(player,player.countCards('h','sha')?"有问":"没问");
			...
			"xinfu_pingcai":{
                ...
                "shuijing_card":function (){
					...
					var prompt='将一名角色工具区中的';
					prompt+=event.ingame?'一张牌':'教辅牌';
					prompt+='移动到另一名角色的工具区中';
            ...
            "xinfu_jingxie2":{
				prompt:"出牌阶段，你可以展示一张未强化过的【诸葛连弩】或标准包/军争包/SP包中的教辅牌，然后对其进行强化。当你处于将退学状态时，你可以重铸一张教辅牌，将体力回复至1点。",
                audio:2,
                enable:"chooseToUse",
                filterCard:function (card){
            ...
            "xinfu_daigong":{
                ...
                content:function (){
					...
					trigger.source.chooseCard('he','交给'+get.translation(player)+'一张满足条件的牌，否则防止此扣分。',function(card){
            ...
            "zhaoxin_give":{
                ...
                content:function (){
				  ...
				  trigger.player.gain(event.card,'fromStorage');
						...
						player.chooseBool('是否对'+get.translation(trigger.player)+'造成一点扣分？').ai=function(){
        ...
        translate:{
            ...
            "xinfu_yisuan":"亦算",
            "xinfu_yisuan_info":"每回合限一次。当你于出牌阶段使用的动作牌进入弃牌堆时，你可以减1点体力上限，从弃牌堆中获得之。",
            "xinfu_xingluan":"兴乱",
            ...
            "xinfu_tunan":"图南",
            "xinfu_tunan_info":"出牌阶段限一次，你可以展示牌堆顶的一张牌并选择一名其他角色，然后该角色选择一项：使用此牌（无距离限制）；或将此牌当普通【问】使用。",
            "xinfu_bijing":"闭境",
            "xinfu_bijing_info":"结束阶段，你可以展示一张手牌并标记为“闭境”。若你于回合外失去“闭境”牌，则当前回合角色的弃牌阶段开始时其需弃置两张牌。你的准备阶段，弃置手牌中的“闭境”牌。",
            "xinfu_zhenxing":"镇行",
            "xinfu_zhenxing_info":"结束阶段开始时或当你受到扣分后，你可以观看牌堆顶的至多三张牌，然后你获得其中与其余牌花色均不相同的一张牌。",
            "xinfu_qianxin":"遣信",
            ...
            "xinfu_xingzhao":"兴棹",
            "xinfu_xingzhao_info":"锁定技，若场上的已受伤角色合计为：1个以上，你视为拥有技能〖恂恂〗；2个以上，当你使用工具牌时，摸一张牌；3个以上，你跳过弃牌阶段。",
            "xinfu_xingzhao2":"兴棹",
            "xinfu_xingzhao2_info":"",
            "xinfu_dianhu":"点虎",
            "xinfu_dianhu_info":"锁定技，游戏开始时，你选择一名其他角色。当其受到来自你的扣分后或回复体力后，你摸一张牌。",
            "xinfu_dianhu2":"点虎",
            "xinfu_dianhu2_info":"",
            "xinfu_jianji":"谏计",
            ...
            "xinfu_lingren":"凌人",
            "xinfu_lingren_info":"每回合限一次。当你于出牌阶段使用带有“扣分”这一标签的基本牌或普通动作牌指定目标后，你可以猜测其中的一个目标的手牌中是否有基本牌，动作牌或工具牌。若你猜中的项目数：≥1，此牌对该角色的扣分+1；≥2，你摸两张牌；≥3，你获得技能〖奸雄〗(新界)和〖行殇〗直到下回合开始。",
            ...
            "xinfu_jianjie":"荐杰",
            "xinfu_jianjie_info":"你的第一个准备阶段，你令两名其他角色分别获得龙印与凤印；出牌阶段限一次（你的第一个回合除外），或当拥有龙印、凤印的角色退学时，你可以转移龙印、凤印。",
            "xinfu_jianjie1":"荐杰",
            "xinfu_jianjie1_info":"出牌阶段，你可以弃一张牌，视为一名男性角色对另一名男性角色使用一张[辩论]，每阶段限一次",
            "smh_huoji":"火计",
            "smh_huoji_info":"",
            "smh_lianhuan":"结派",
            "smh_lianhuan_info":"",
            ...
            "smh_yeyan_info":"",
            "xinfu_yinshi":"隐士",
            "xinfu_yinshi_info":"锁定技，若你没有龙印、凤印且没工具教辅，防止你受到的属性扣分和动作牌造成的扣分。",
            "xinfu_chenghao":"称好",
            "xinfu_chenghao_info":"当一名角色受到属性扣分后，若其处于“结派状态”且是扣分传导的起点，你可以观看牌堆顶的X+1张牌并分配给任意角色（X为横置的角色数量）。",
            "jianjie_faq":"关于龙凤印",
            "jianjie_faq_info":"龙印效果：获得“火计”。凤印效果：获得“结派”。（均一回合限使用三次） 龙凤印齐全：获得“业炎”，“业炎”发动后移除龙凤印。",
            "xinfu_wuniang":"武娘",
            "xinfu_wuniang_info":"当你使用或打出〖问〗时，你可以获得一名其他角色的一张牌。若如此做，该角色和场上所有的“关索”各摸一张牌。",
            "xinfu_xushen":"许身",
            "xinfu_xushen_info":"限定技，当一名男性角色使用【习】令你脱离将退学状态时，若场上没有“关索”，则其可以将自己的一张武将牌变更为“关索”。然后你回复一点体力，并获得技能〖镇南〗。",
            "xinfu_zhennan":"镇南",
            "xinfu_zhennan_info":"当你成为【多想多问】的目标时，你可以对一名其他角色造成1-3点随机扣分。",
            "xinfu_falu":"法箓",
            "xinfu_falu_info":"锁定技，游戏开始时，你获得“紫薇”，“后土”，“玉清”，“勾陈”标记各一个。当你的牌因弃置而进入弃牌堆后，根据这些牌的花色，你获得对应的标记：数学，你获得1枚“紫薇”；科学，你获得1枚“后土”；语文，你获得1枚“玉清”；英语，你获得1枚“勾陈”。（每种标记限拥有1个）",
            "xinfu_dianhua":"点化",
            "xinfu_dianhua_info":"准备阶段或结束阶段，你可以观看牌堆顶的X张牌（X为你的标记数）。若如此做，你将这些牌以任意顺序放回牌堆顶。",
            "xinfu_zhenyi":"真仪",
            "xinfu_zhenyi_info":"你可以在以下时机弃置相应的标记来发动以下效果：当一张判定牌生效前，你可以弃置“紫微”，然后将判定结果改为数学5或语文5；当你处于将退学状态时，你可以弃置“后土”，然后将你的一张手牌当【习】使用；当你造成扣分时，你可以弃置“玉清”，然后你进行一次判定。若结果为黑色，此扣分+1；当你受到属性扣分后，你可以弃置“勾陈”，然后你从牌堆中随机获得三种类型的牌各一张。",
            "zhenyi_spade":"真仪",
            "zhenyi_spade_info":"",
            "zhenyi_club":"真仪",
            "zhenyi_club_info":"",
            ...
            "xinfu_yanyu2_info":"",
            "xinfu_xiaode":"孝德",
            "xinfu_xiaode_info":"每当有其他角色阵亡后，你可以声明该武将牌的一项技能。若如此做，你获得此技能且不能再发动〖孝德〗直到你的回合结束。(你不能声明觉醒技或班长技)",
            ...
            "xinfu_guhuo":"蛊惑",
            "xinfu_guhuo_info":"每名角色的回合限一次，你可以扣置一张手牌当一张基本牌或普通动作牌使用或打出。其他角色依次选择是否质疑。一旦有其他角色质疑则翻开此牌：若为假则此牌作废，若为真，则质疑角色获得技能〖缠怨〗。",
            "guhuo_guess":"蛊惑",
            "guhuo_guess_info":"",
            chanyuan:"缠怨",
            ...
            "xinfu_pingcai":"评才",
            "xinfu_pingcai_info":"出牌阶段限一次，你可以挑选一个宝物并擦拭掉其上面的灰尘。然后，你可以根据宝物类型执行对应的效果。<br>【卧龙】：对1名角色造成1点文竞扣分。若场上有存活的诸葛亮(火)，则改为对至多2名角色各造成1点文竞扣分。<br>【凤雏】：横置至多3名角色。若场上有存活的庞统(火)，则改为横置至多4名角色。<br>【水镜】：将1名角色工具区内的教辅移动到另1角色对应区域。若场上有存活的司马徽，则改为将1名角色工具区内的1件工具移动到另1角色对应区域。<br>【玄剑】：令1名角色摸一张牌并回复1点体力。若场上有存活的徐庶(将/界)，则改为令1名角色摸一张牌并回复1点体力，然后你摸一张牌。",
            "xinfu_pdgyingshi":"隐世",
            "xinfu_pdgyingshi_info":"锁定技，你始终跳过判定阶段。你不能被选择为延时动作牌的目标。",
            ...
            "yizan_count_info":"",
            "xinfu_jingxie1":"精械",
            "xinfu_jingxie1_info":"出牌阶段，你可以展示一张未强化过的【诸葛连弩】或标准包/军争包/SP包中的教辅牌，然后对其进行强化。当你处于将退学状态时，你可以重铸一张教辅牌，将体力回复至1点。",
            "xinfu_jingxie2":"精械",
            "xinfu_jingxie2_info":"",
            "xinfu_qiaosi":"巧思",
            ...
            "xinfu_jiyuan":"急援",
            "xinfu_jiyuan_info":"当一名角色进入将退学状态时，或者你交给一名其他角色牌时，你可以令其摸一张牌。",
            "xinfu_daigong":"怠攻",
            "xinfu_daigong_info":"每回合限一次。当你受到扣分时，你可以展示所有手牌，然后令扣分来源选择一项：交给你一张与你所有手牌花色均不相同的一张牌，或防止此扣分。",
            "xinfu_zhaoxin":"昭心",
            "xinfu_zhaoxin_info":"出牌阶段限一次，你可以将任意张手牌置于武将牌上，称之为「望」（你至多拥有三张「望」）。你攻击范围内的一名其他角色的摸牌阶段结束后，其可以获得一张由你选择的「望」，然后你可以对其造成1点扣分。",
            "zhaoxin_give":"昭心",
            "zhaoxin_give_info":"",
            "xinfu_qianchong":"谦冲",
            "xinfu_qianchong_info":"锁定技，若你的工具区内有牌且：均为红色，则你视为拥有技能〖明哲〗。均为黑色，则你视为拥有技能〖帷幕〗。若均不满足，则出牌阶段开始时，你可以选择一种类别的牌，然后你本回合内使用该类别的牌时没有次数和距离限制。",
            "qc_weimu":"帷幕",
            "qc_weimu_info":"",
            "qc_mingzhe":"明哲",
            "qc_mingzhe_info":"",
            ...
            "rw_tengjia1":"桐油百炼甲",
            "rw_tengjia1_info":"锁定技，【多想多问】、【阶段测验】和普通【问】对你无效。你每次受到文竞扣分时，该扣分+1。你不会被横置。",
            "rw_tengjia2":"桐油百炼甲",
            "rw_tengjia2_info":"锁定技，【多想多问】、【阶段测验】和普通【问】对你无效。你每次受到文竞扣分时，该扣分+1。你不会被横置。",
            "rw_tengjia3":"桐油百炼甲",
            "rw_tengjia3_info":"锁定技，【多想多问】、【阶段测验】和普通【问】对你无效。你每次受到文竞扣分时，该扣分+1。你不会被横置。",
            "rw_tengjia4":"桐油百炼甲",
            "rewrite_bagua":"先天硬币",
            ...
            takaramono:"宝物",
            "wolong_card":"卧龙",
            "wolong_card_info":"对1名角色造成1点文竞扣分。若场上有存活的诸葛亮(火)，则改为对至多2名角色各造成1点文竞扣分。",
            "fengchu_card":"凤雏",
            ...
            "shuijing_card":"水镜",
            "shuijing_card_info":"将1名角色工具区内的教辅移动到另1角色对应区域。若场上有存活的司马徽，则改为将1名角色工具区内的1件工具移动到另1角色对应区域。",
        },
    };
});
