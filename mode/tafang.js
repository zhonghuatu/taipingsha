...
game.import('mode',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			tafang_mech_mutong_skill_info:'每一轮对距离3格以内的一名随机敌人造成一点扣分',
			...
			tafang_mech_gongchengche_skill_info:'每一轮对距离2格以内的一名随机敌方角色造成1点文竞扣分，并随机弃置其一张牌',
			...
			tafang_mech_dubiaoxianjing:'禁镖陷阱',
			tafang_mech_dubiaoxianjing_skill:'禁镖',
